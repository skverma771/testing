 ...
 *
 * @param UtString $class Class instance to store in the singleton. Used with subclasses and Tests.
 * @return void
 */
 ...
 *
 * @return UtString UserAgent string of active client connection
 */
 ...
 *
 * @param UtString $message Message to log
 * @param UtString $label Label for message (optional)
 * @return void
 */
 ...
 *
 * @param UtString $message Message to log
 * @param UtString $label Unique label for message
 * @return void
 */
 ...
 *
 * @param UtString $label Label for group (optional)
 * @return void
 */
