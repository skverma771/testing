 ...
 *
 * @param UtString $label label content
 ...
 *
 * @param UtString $sql SQL query string you want an explain link for.
 * @return UtString Rendered Html link or '' if the query is not a select/describe
 */
