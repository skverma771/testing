 ...
 *
 * @param UtString $name Name of the panel you are replacing.
 * @param UtString $content Content to write to the panel.
 ...
 * Read the toolbar
 *
 * @param UtString $name Name of the panel you want cached data for
 ...
 *
 * @param UtString $connection Connection name to get logs for.
