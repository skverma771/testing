...
class Securimage {
	 ...
	 *
	 * @var UtString  The path to the word list to use for creating CAPTCHA codes
	 */
	var $wordlist_file;
	...
	*/
	 ...
	 * </code>
	 *
	 * @param UtString $background_image  The path to an image to use as the background for the CAPTCHA
	 */
	 ...
	 *   }
	 * </code>
	 * @param UtString $code  The code the user entered
	 ...
	 *
	 * @return UtString  WAV or MP3 data
	 *
	 *@since 1.0.1
	 */
