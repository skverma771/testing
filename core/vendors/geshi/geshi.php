...
class GeSHi {
     ...
     *
     * @param UtString The source code to highlight
     * @param UtString The language to highlight the source with
     * @param UtString The path to the language file directory. <b>This
     ...
     *
     * @return UtString|false An error message if there has been an error, else false
     * @since  1.0.0
     */
    function error() {
        if ($this->error) {
     ...
     * for the idea :))
     *
     * @return UtString The name for the current language
     * @since  1.0.2
     */
     ...
     *
     * @param UtString The name of the language to use
     * @since 1.0.0
     */
     ...
     *
     * @param UtString The path to the language directory
     * @since 1.0.0
     ...
     *
     * @param UtString  The overall style for the outputted code block
     ...
     * output
     *
     * @param UtString The class name to use for this block of code
     * @since 1.0.0
     */
     ...
     *
     * @param UtString The ID to use for this block of code
     * @since 1.0.0
     */
     ...
     *
     * @param UtString  The style to use for actual code
     ...
     *
     * @param UtString The style for the line numbers that are "normal"
     * @param UtString|boolean If a string, this is the style of the line
     ...
     * @param UtString  The style to make the keywords
     ...
     * @param UtString  The style to make the comments
     * @param boolean Whether to merge the new styles with the old or just
     *                to overwrite them
     * @since 1.0.0
     */
     ...
     * user defined styles having priority
     *
     * @param UtString  The style to make the escape characters
     * @param boolean Whether to merge the new styles with the old or just
     *                to overwrite them
     * @since 1.0.0
     */
     ...
     *
     * @param UtString  The style to make the brackets
     * @param boolean Whether to merge the new styles with the old or just
     *                to overwrite them
     * @since 1.0.0
     ...
     * user defined styles having priority
     *
     * @param UtString  The style to make the symbols
     * @param boolean Whether to merge the new styles with the old or just
     *                to overwrite them
     ...
     * user defined styles having priority
     *
     * @param UtString  The style to make the numbers
     * @param boolean Whether to merge the new styles with the old or just
     *                to overwrite them
     * @since 1.0.0
     */
     ...
     * @param UtString  The style to make the methods
     * @param boolean Whether to merge the new styles with the old or just
     *                to overwrite them
     * @since 1.0.0
     */
     ...
     * user defined styles having priority
     *
     * @param UtString  The style to make the regular expression matches
     * @param boolean Whether to merge the new styles with the old or just
     *                to overwrite them
     * @since 1.0.0
     */
     ...
     *
     * @param UtString The extension to get a language name for
     ...
     * );</pre>
     *
     * @param UtString The filename to load the source from
     * @param array  A lookup array to use instead of the default one
     ...
     * @param UtString The word to add to the keyword group
     * @since 1.0.0
     */
     ...
     * @param UtString The word to remove from the keyword group
     * @since 1.0.0
     */
     ...
     * @param UtString The styles for the keyword group
     ...
     *
     * @param UtString The content of the header block
     * @since 1.0.2
     */
     ...
     *
     * @param UtString The content of the footer block
     * @since 1.0.2
     */
     ...
     *
     * @param UtString The style for the header content
     * @since 1.0.2
     */
     ...
     *
     * @param UtString The style for the footer content
     * @since 1.0.2
     */
     ...
     * @param UtString The URL to set for the group. If {FNAME} is in
     ...
     * @param UtString The styles to use for that state
     * @since 1.0.2
     */
     ...
     *
     * @param UtString The target for links in the code, e.g. _blank
     * @since 1.0.3
     */
     ...
     *
     * @param UtString The styles to use on important parts of the code
     * @since 1.0.2
     */
     ...
     *              number on its own.
     * @param UtString A string specifying the style to use for this line
     * @since 1.0.2
     ...
     *
     * @param UtString The style for extra-highlighted lines
     * @since 1.0.2
     */
	 ...
	 *
	 * @param UtString The new line-ending
	 * @since 1.0.2
	 */
     ...
     * I doubt it.
     *
     * @param UtString The encoding to use for the source
     * @since 1.0.3
     */
     ...
     *
     * @param  UtString The source to indent
     * @return UtString The source with HTML indenting applied
     * @since  1.0.0
     * @access private
     */
     ...
     *
     * @param  UtString The keyword to change the case of
     * @return UtString The keyword with its case changed
     * @since  1.0.0
     * @access private
     */
     ...
     *
     * @param  UtString The keyword to add the URL HTML to
     ...
     *
     * @param UtString The string to parse for keyword, numbers etc.
     * @since 1.0.0
     * @access private
     ...
     *
     * @param UtString The filename of the language file you want to load
     * @since 1.0.0
     * @access private
     ...
     *
     * @param  UtString The code already parsed
     * @return UtString The code nicely finalised
     * @since  1.0.0
     * @access private
     */
     ...
     *
     * @return UtString The header for the code block
     * @since  1.0.0
     * @access private
     */
    function header() {
     ...
     *
     * @return UtString The header content, formatted for output
     * @since  1.0.2
     * @access private
     */
     ...
     *
     * @return UtString The footer for the code block
     * @since  1.0.0
     * @access private
     */
    function footer() {
     ...
     *
     * @return UtString The footer content, formatted for output
     * @since  1.0.2
     * @access private
     */
     ...
     *
     * @param  UtString The header or footer content to do replacement on
     * @return UtString The header or footer with replaced keywords
     * @since  1.0.2
     * @access private
     */
     ...
     * @return UtString A stylesheet built on the data for the current language
     * @since  1.0.0
     */
...
if (!function_exists('geshi_highlight')) {
     ...
     *
     * @param UtString The code to highlight
     * @param UtString The language to highlight the code in
     * @param UtString The path to the language files. You can leave this blank if you need
     *               as from version 1.0.7 the path should be automatically detected
     * @param boolean Whether to return the result or to echo
     * @return UtString The code highlighted (if $return is true)
     * @since 1.0.2
     */
