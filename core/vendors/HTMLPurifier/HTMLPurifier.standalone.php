...
class HTMLPurifier
{
     ...
     *
     * @param $html UtString of HTML to purify
...
abstract class HTMLPurifier_AttrDef
{
     ...
     *
     * @param $string UtString to be validated and cleaned.
     ...
     * @param $string UtString construction info
...
class HTMLPurifier_AttrTypes
{
    ...
    /**
     * Retrieves a type
     * @param $type UtString type name
     * @return CakeObject AttrDef for type
     */
     ...
     * @param $type UtString type name
     * @param $impl CakeObject AttrDef for type
     */
...
class HTMLPurifier_Config
{
     ...
     * @param $namespace UtString namespace
     * @param $key UtString key
     */
     ...
     * @param $error UtString error message, or false for no error
     */
...
class HTMLPurifier_Encoder
{
     ...
     *
     * @param UtString $encoding Encoding name to test, as per iconv format
...
//     1. hex             2. dec      3. string (XML style)
     ...
     *
     * @param $string UtString to have non-special entities parsed.
...
class HTMLPurifier_ErrorCollector
{
     ...
     * @param $msg UtString Error message text
     * @param $subst1 UtString First substitution for $msg
     * @param $subst2 UtString ...
     */
...
class HTMLPurifier_Generator
{
     ...
     * @param $string UtString data to escape for HTML.
     * @param $quote Quoting style, like htmlspecialchars. ENT_NOQUOTES is
     *               permissible for non-attribute output.
     * @return UtString escaped data.
...
class HTMLPurifier_HTMLDefinition extends HTMLPurifier_Definition
{
     ...
     * @param $element_name UtString element name to add attribute to
     * @param $attr_name UtString name of attribute
     ...
     * @param $list UtString list to parse
...
class HTMLPurifier_Language
{
     ...
     * @param $key UtString identifier of message
     * @return UtString localised message
     */
...
class HTMLPurifier_LanguageFactory
{
     ...
     * @param $code UtString language code
     */
...
class HTMLPurifier_Length
{
    ...
    /**
     * @param UtString $s Unit string, like '2em' or '3.4in'
...
class HTMLPurifier_Lexer
{
     ...
     *
     * @param $string UtString character data to be parsed.
...
class HTMLPurifier_PercentEncoder
{
     ...
     * @param $string UtString to be encoded
     ...
     * @param $string UtString to normalize
     */
...
class HTMLPurifier_URI
{
     ...
     * @return UtString URI appropriate for output
     */
    public function toString() {
...
class HTMLPurifier_URIParser
{
    ...
    /**
     * Parses a URI.
     * @param $uri UtString URI to parse
...
class HTMLPurifier_URISchemeRegistry
{
     ...
     * @param $scheme UtString scheme name like http or mailto
     * @param $config HTMLPurifier_Config object
...
class HTMLPurifier_UnitConverter
{
     ...
     * @param UtString $n Decimal number
...
class HTMLPurifier_AttrDef_Switch
{
    ...
    /**
     * @param UtString $tag Tag name to switch upon
...
class HTMLPurifier_AttrTransform_BoolToCSS extends HTMLPurifier_AttrTransform {
    ...
    /**
     * @param $attr UtString attribute name to convert from
     * @param $css UtString CSS declarations to add to style (needs semicolon)
     */
...
class HTMLPurifier_AttrTransform_EnumToCSS extends HTMLPurifier_AttrTransform {
    ...
    /**
     * @param $attr UtString attribute name to transform from
...
class HTMLPurifier_HTMLModule_Tidy extends HTMLPurifier_HTMLModule
{
     ...
     * @param $level UtString level identifier, see $levels for valid values
     ...
     * @param $name UtString name of fix
...
class HTMLPurifier_Injector_AutoParagraph extends HTMLPurifier_Injector
{
     ...
     * @param $data UtString text data that will be processed
     *    into paragraphs
...
class HTMLPurifier_Token_Comment extends HTMLPurifier_Token
{
     ...
     *
     * @param $data UtString comment data.
     */
...
class HTMLPurifier_Token_Text extends HTMLPurifier_Token
{
     ...
     *
     * @param $data UtString parsed character data.
     */
    public function __construct($data, $line = null, $col = null) {
        $this->data = $data;
