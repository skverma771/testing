...
class Less_Parser{
	 ...
	 *
	 * @param  UtString   $name     function name
	 ...
	 *
	 * @param UtString $str The string to convert
	 * @param UtString $uri_root The url of the file
	 ...
	 *
	 * @param UtString $filename The file to parse
     * @param UtString $uri_root The url of the file
