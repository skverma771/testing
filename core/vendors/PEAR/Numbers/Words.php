...
class Numbers_Words
{
     ...
     *
     * @param  UtString  $locale Language name abbreviation. Optional. Defaults to en_US.
     *
     * @return UtString  The corresponding word representation
     *
     * @access public
     * @author Piotr Klaban <makler@man.torun.pl>
     * @since  PHP 4.2.3
     ...
     * @param  UtString  $locale Language name abbreviation. Optional. Defaults to en_US.
     *
     * @param  UtString  $int_curr International currency symbol
