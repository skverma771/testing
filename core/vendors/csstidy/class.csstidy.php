 ...
 * @param UtString $content either filename (if $from_file == true), content of a template file, "high_compression", "highest_compression", "low_compression", or "default"
 ...
 * @param UtString $string the CSS code
 * @access public
 * @return bool
 * @version 1.1
 */
 ...
 * @param UtString $media
 * @param UtString $selector
 * @param UtString $property
 * @param UtString $new_val
 * @access private
 * @version 1.2
 */
