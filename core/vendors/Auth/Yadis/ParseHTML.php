...
class Auth_Yadis_ParseHTML {
     ...
     *
     * @access private
     * @param UtString $str The string in which to look for entities
     * @return UtString $new_str The new string entities decoded
     */
     ...
     *
     * @access private
     * @param UtString $str The original string
     * @return UtString $new_str The new string with leading and
     ...
     * @return UtString $regex A regular expression string to be used
     * in, say, preg_match.
     */
     ...
     *
     * @access private
     * @param UtString $html_string An HTMl document string
     ...
     * value is returned.
     *
     * @param UtString $html_string An HTML document in string format
