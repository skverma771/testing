...
class Auth_Yadis_XMLParser {
     ...
     * subclasses.
     *
     * @param UtString $xml_string A string of XML to be parsed.
     ...
     *
     * @param UtString $prefix The namespace prefix to appear in XML tag
     * names.
     *
     * @param UtString $uri The namespace URI to be used to identify the
     ...
     * overridden by subclasses.
     *
     * @param UtString $xml_string The XML string to pass to this
     * object's XML parser.
     *
     ...
     *
     * @param UtString $xpath The XPath expression to be evaluated.
     *
     ...
     * $this->evalXPath().
     *
     * @return UtString $content The content of this node.
     */
