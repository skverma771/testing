...
class Auth_Yadis_PHPSession {
     ...
     *
     * @param UtString $name The name of the session key to add.
     * @param UtString $value The value to add to the session.
     */
     ...
     *
     * @param UtString $name The name of the key to retrieve.
     * @param UtString $default The optional value to return if the key
     * is not found in the session.
     * @return UtString $result The key's value in the session or
     ...
     *
     * @param UtString $name The name of the key to remove.
     */
    function del($name)
    {
        unset($_SESSION[$name]);
...
class Auth_Yadis_Discovery {
     ...
     * @param UtString $url The URL on which to attempt discovery.
     * @param UtString $session_key_suffix The optional session key
     * suffix override.
     */
