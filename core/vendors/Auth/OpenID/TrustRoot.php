...
class Auth_OpenID_TrustRoot {
     ...
     * @access private
     *
     * @param UtString $trust_root The url to parse
     *
     ...
     *
     * @static
     * @param UtString $trust_root The trust root to check
     ...
     *
     * @param UtString $trust_root The trust root to match against
     *
     * @param UtString $url The URL to check
     *
