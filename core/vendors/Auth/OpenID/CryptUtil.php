...
class Auth_OpenID_CryptUtil {
     ...
     * @return UtString $bytes random bytes
     */
     ...
     * @param UtString $chrs A string of characters from which to choose
     * to build the new string
     * @return UtString $result A string of randomly-chosen characters
     * from $chrs
     */
