...
class Auth_OpenID_Association {
     ...
     *
     * @param UtString $handle This is the handle the server gave this
     * association.
     *
     * @param UtString secret This is the shared secret the server
     ...
     * association was issued.
     *
     * @param UtString $assoc_type This is the type of association this
     * instance represents.  The only valid values of this field at
     * this time is 'HMAC-SHA1' and 'HMAC-SHA256', but new types may
     * be defined in the future.
     */
     ...
     *
     * @return UtString $result String in KV form suitable for
     ...
     *
     * @param UtString $assoc_s Association as serialized by serialize()
     ...
     * array of two-tuples.
     * @return UtString $signature The binary signature of this sequence
     * of pairs
     */
    function sign($pairs)
    {
     ...
     * string => string pairs).
     * @return UtString $signature The signature, base64 encoded
     */
