...
class Auth_OpenID_OpenIDStore {
     ...
     *
     * @param UtString $server_url The URL of the identity server that
     ...
     *
     * @param UtString $server_url The URL of the identity server to get
     ...
     *
     * @param UtString $server_url The URL of the identity server the
     ...
     *
     * @param UtString $handle This is the handle of the association to
     ...
     * interface.
     *
     * @param UtString $nonce The nonce to use.
     *
