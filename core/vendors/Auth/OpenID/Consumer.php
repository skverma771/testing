...
class Auth_OpenID_Consumer {
     ...
     *
     * @param UtString $user_url Identity URL given by the user. This
     ...
     * consumer overview.
     *
     * @param UtString $current_url The URL used to invoke the application.
...
class Auth_OpenID_AuthRequest {
     ...
     * get quite long.
     *
     * @param UtString $namespace The namespace for the extension. For
     * example, the simple registration extension uses the namespace
     * 'sreg'.
     *
     * @param UtString $key The key within the extension namespace. For
     * example, the nickname field in the simple registration
     * extension's key is 'nickname'.
     *
     * @param UtString $value The value to provide to the server for
     * this argument.
     */
     ...
     * request.
     *
     * @param UtString $realm The URL (or URL pattern) that identifies
     * your web site to the user when she is authorizing it.
     *
     * @param UtString $return_to The URL that the OpenID provider will
...
class Auth_OpenID_SuccessResponse extends Auth_OpenID_ConsumerResponse {
     ...
     *
     * @param UtString $prefix The extension namespace from which to
     ...
     * this consumer.
     *
     * @return UtString $return_to The return_to URL supplied to the
