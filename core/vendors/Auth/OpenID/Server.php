...
class Auth_OpenID_CheckIDRequest extends Auth_OpenID_Request {
     ...
     *
     * @param UtString $server_url DEPRECATED.  Passing $op_endpoint to
     ...
     * $allow is true.
     *
     * @param UtString $identity The OP-local identifier to answer with.
     * Only for use when the relying party requested identifier
     * selection.
     *
     * @param UtString $claimed_id The claimed identifier to answer
