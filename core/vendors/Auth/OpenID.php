...
class Auth_OpenID {
     ...
     * sequentially.
     * @return UtString $result The result of url-encoding the key/value
     ...
     *
     * @access private
     * @param UtString $url A URL, which may or may not already have
     * arguments.
     ...
     * @return UtString $url The original URL with the new parameters added.
     *
     */
     ...
     *
     * @access private
     * @param UtString $scheme The scheme (e.g. 'http').  Defaults to 'http'.
     * @param UtString $host The host.  Required.
     * @param UtString $port The port.
     * @param UtString $path The path.
     * @param UtString $query The query.
     * @param UtString $fragment The fragment.
     * @return UtString $url The URL resulting from assembling the
     ...
     *
     * @access private
     * @param UtString $url The URL to be normalized.
     ...
     *
     * @param UtString $str The string of bytes to count.
     ...
     *
     * @param UtString $format_string The sprintf format for the message
     */
