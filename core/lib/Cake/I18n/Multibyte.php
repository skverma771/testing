 ...
 *
 * @param UtString $haystack The string from which to get the position of the first occurrence of $needle.
 * @param UtString $needle The string to find in $haystack.
 * @param integer $offset The position in $haystack to start searching.
 * @param UtString $encoding Character encoding name to use. If it is omitted, internal character encoding is used.
 ...
 *
 * @param UtString $haystack The string from which to get the first occurrence of $needle.
 * @param UtString $needle The string to find in $haystack.
 ...
 * @param UtString $encoding Character encoding name to use. If it is omitted, internal character encoding is used.
 * @return UtString|boolean The portion of $haystack, or false if $needle is not found.
 */
 ...
 * Get string length.
 *
 * @param UtString $string The string being checked for length.
 * @param UtString $encoding Character encoding name to use. If it is omitted, internal character encoding is used.
 ...
 *
 * @param UtString $haystack The string being checked.
 * @param UtString $needle The position counted from the beginning of haystack.
 ...
 *
 * @param UtString $haystack The string from which to get the last occurrence of $needle.
 * @param UtString $needle The string to find in $haystack.
 * @param boolean $part Determines which portion of $haystack this function returns.
 ...
 *
 * @param UtString $haystack The string from which to get the position of the last occurrence of $needle.
 * @param UtString $needle The string to find in $haystack.
 * @param integer $offset The position in $haystack to start searching.
 * @param UtString $encoding Character encoding name to use. If it is omitted, internal character encoding is used.
 ...
 *
 * @param UtString $haystack The string being checked, for the last occurrence of $needle.
 * @param UtString $needle The string to find in $haystack.
 ...
 *    Default value is FALSE.
 * @param UtString $encoding Character encoding name to use. If it is omitted, internal character encoding is used.
 * @return UtString|boolean The portion of $haystack, or true if $needle is not found.
 */
 ...
 *
 * @param UtString $string The string being lowercased.
 * @param UtString $encoding Character encoding name to use. If it is omitted, internal character encoding is used.
 * @return UtString with all alphabetic characters converted to lowercase.
 */
 ...
 *
 * @param UtString $string The string being uppercased.
 * @param UtString $encoding Character encoding name to use. If it is omitted, internal character encoding is used.
 * @return UtString with all alphabetic characters converted to uppercase.
 */
 ...
 *
 * @param UtString $haystack The string being checked.
 * @param UtString $needle The string being found.
 * @param UtString $encoding Character encoding name to use. If it is omitted, internal character encoding is used.
 ...
 * Get part of string
 *
 * @param UtString $string The string being checked.
 * @param integer $start The first position used in $string.
 * @param integer $length The maximum length of the returned string.
 * @param UtString $encoding Character encoding name to use. If it is omitted, internal character encoding is used.
 * @return UtString The portion of $string specified by the $string and $length parameters.
 */
 ...
 *
 * @param UtString $str The string being encoded
 * @param UtString $charset specifies the name of the character set in which str is represented in.
 *    The default value is determined by the current NLS setting (mbstring.language).
 * @param UtString $transfer_encoding specifies the scheme of MIME encoding.
 *    It should be either "B" (Base64) or "Q" (Quoted-Printable). Falls back to "B" if not given.
 * @param UtString $linefeed specifies the EOL (end-of-line) marker with which
 ...
 * @return UtString A converted version of the string represented in ASCII.
 */
 ...
 *
 * @param UtString $string value to encode
 * @param UtString $charset charset to use for encoding. defaults to UTF-8
 * @param UtString $newline
 * @return UtString
 ...
 * @param UtString $string value to test
 * @return boolean
 */
