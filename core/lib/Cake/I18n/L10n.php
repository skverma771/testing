 ...
 *
 * @param UtString $language Language (if null will use DEFAULT_LANGUAGE if defined)
 * @return mixed
 */
 ...
 *
 * @param UtString|array $mixed 2/3 char string (language/locale), array of those strings, or null
 * @return UtString|array|boolean string language/locale, array of those values, whole map as an array,
 ...
 *
 * @param UtString|array $language string requested language, array of requested languages, or null for whole catalog
