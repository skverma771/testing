 ...
 *
 * @param UtString $singular String to translate
 * @param UtString $plural Plural string (if any)
 * @param UtString $domain Domain The domain of the translation.  Domains are often used by plugin translations
 * @param UtString $category Category The integer value of the category to use.
 * @param integer $count Count Count is used with $plural to choose the correct plural form.
 * @param UtString $language Language to translate string to.
 * 	If null it checks for language in session followed by Config.language configuration variable.
 * @return UtString translated string.
 */
 ...
 *
 * @param UtString $domain Domain to bind
 * @return UtString Domain binded
 */
 ...
 *
 * @param UtString $filename Binary .mo file to load
 ...
 *
 * @param UtString $filename Text .po file to load
 * @return mixed Array of translations on success or false on failure
 */
 ...
 *
 * @param UtString $filename Locale definition filename
 ...
 *
 * @param UtString $string Symbol to be parsed
 * @return UtString parsed symbol
 */
 ...
 *
 * @param UtString $format Format to be translated
 * @param UtString $domain Domain where format is stored
