 ...
 * @param UtString $var Variable to obtain.  Use '.' to access array elements.
 ...
 * @param UtString $var the var to be deleted
 * @return void
 */
 ...
 *
 * @param UtString $name The name of the reader being configured.  This alias is used later to
 ...
 *
 * @param UtString $name Name of the reader to drop.
 ...
 * @param UtString $key name of configuration resource to load.
 * @param UtString $config Name of the configured reader to use to read the resource identified by $key.
 ...
 *
 * @param UtString $key The identifier to create in the config adapter.
 *   This could be a filename or a cache key depending on the adapter being used.
 * @param UtString $config The name of the configured adapter to dump data with.
 ...
 *
 * @return UtString Current version of CakePHP
 */
 ...
 *
 * @param UtString $name The storage name for the saved configuration.
 * @param UtString $cacheConfig The cache configuration to save into.  Defaults to 'default'
 ...
 *
 * @param UtString $name Name of the stored config file to load.
 * @param UtString $cacheConfig Name of the Cache configuration to read from.
 * @return boolean Success.
 */
