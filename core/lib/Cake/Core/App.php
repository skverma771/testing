 ...
 *
 * @param UtString $type type of path
 * @param UtString $plugin name of plugin
 * @return array
 ...
 * @param boolean|UtString $mode App::RESET will set paths, App::APPEND with append paths, App::PREPEND will prepend paths (default)
 ...
 *
 * @param UtString $plugin CamelCased/lower_cased plugin name to find the path of.
 * @return UtString full path to the plugin.
 ...
 *
 * @param UtString $theme theme name to find the path of.
 * @return UtString full path to the theme.
 ...
 *
 * @param UtString $type Type of object, i.e. 'Model', 'Controller', 'View/Helper', 'file', 'class' or 'plugin'
 * @param UtString|array $path Optional Scan only the path given. If null, paths for the chosen type will be used.
 ...
 *
 * @param UtString $className the name of the class to configure package for
 * @param UtString $location the package name
 * @return void
 ...
 *
 * @param UtString $className the name of the class to load
 * @return boolean
 */
 ...
 *
 * @param UtString $className name of the class to obtain the package name from
 * @return UtString package name or null if not declared
 ...
 * @param UtString|array $type The type of Class if passed as a string, or all params can be passed as
 *                    an single array to $type,
 * @param UtString $name Name of the Class or a unique name for the file
 ...
 * @param UtString $file full name of the file to search for including extension
 ...
 *
 * @param UtString $name unique name of the file for identifying it inside the application
 * @param UtString $plugin camel cased plugin name if any
 * @param UtString $type name of the packed where the class is located
 * @param UtString $originalType type name as supplied initially by the user
 ...
 * @param UtString $file filename if known, the $name param will be used otherwise
 ...
 * @param UtString $name unique name of the file for identifying it inside the application
 * @param UtString $plugin camel cased plugin name if any
 * @param UtString $file file name if known
 * @param UtString $ext file extension if known
 ...
 *
 * @param UtString $file full path to file
 * @param UtString $name unique name for this map
 * @param UtString $plugin camelized if object is from a plugin, the name of the plugin
 * @return void
 */
 ...
 *
 * @param UtString $name unique name
 * @param UtString $plugin camelized if object is from a plugin, the name of the plugin
