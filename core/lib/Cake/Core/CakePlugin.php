 ...
 *
 * @param UtString|array $plugin name of the plugin to be loaded in CamelCase format or array or plugins to load
 ...
 *
 * @param UtString $plugin name of the plugin in CamelCase format
 * @return UtString path to the plugin folder
 ...
 *
 * @param UtString $plugin name of the plugin
 * @return mixed
 ...
 *
 * @param UtString $plugin name of the plugin, if null will operate on all plugins having enabled the
 ...
 *
 * @param UtString $plugin name of the plugin to forget
 * @return void
 */
