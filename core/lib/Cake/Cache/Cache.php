 ...
 *
 * @param UtString $name Name of the configuration
 ...
 *
 * @param UtString $name Name of the config array that needs an engine instance built
 * @return boolean
 * @throws CacheException
 */
 ...
 *
 * @param UtString $name A currently configured cache config you wish to remove.
 ...
 *
 * @param UtString|array $settings Optional string for simple name-value pair or array
 * @param UtString $value Optional for a simple name-value pair
 * @param UtString $config The configuration name you are changing. Defaults to 'default'
 ...
 *
 * @param UtString $config [optional] The config name you wish to have garbage collected. Defaults to 'default'
 ...
 *
 * @param UtString $key Identifier for the data
 * @param mixed $value Data to be cached - anything except a resource
 * @param UtString $config Optional string configuration name to write to. Defaults to 'default'
 ...
 *
 * @param UtString $key Identifier for the data
 * @param UtString $config optional name of the configuration to use. Defaults to 'default'
 ...
 * @param UtString $config Optional string configuration name. Defaults to 'default'
 ...
 *
 * @param UtString $key Identifier for the data
 * @param UtString $config name of the configuration to use. Defaults to 'default'
 ...
 *
 * @param UtString $group name of the group to be cleared
 * @param UtString $config name of the configuration to use. Defaults to 'default'
 ...
 *
 * @param UtString $name Name of the configuration to get settings for. Defaults to 'default'
