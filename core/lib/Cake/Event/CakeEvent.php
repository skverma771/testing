 ...
 * Constructor
 *
 * @param UtString $name Name of the event
 * @param CakeObject $subject the object that this event applies to (usually the object that is generating the event)
