 ...
 *
 * @param UtString $eventKey The event unique identifier name to with the callback will be associated. If $callable
 ...
 * @param UtString $eventKey optional event key name to unsubscribe the listener from
 * @return void
 */
 ...
 *
 * @param UtString|CakeEvent $event the event key name or instance of CakeEvent
 * @return void
 */
