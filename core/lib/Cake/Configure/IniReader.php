 ...
 *
 * @param UtString $path Path to load ini config files from.
 * @param UtString $section Only get one section, leave null to parse and fetch
 ...
 *
 * @param UtString $file Name of the file to read. The chosen file
 ...
 *
 * @param UtString $filename The filename on $this->_path to save into.
 ...
 * @return UtString String value for ini file.
 */
