 ...
 * Constructor.
 *
 * @param UtString $path Path to folder
 * @param boolean $create Create folder if not found
 * @param UtString|boolean $mode Mode (CHMOD) to apply to created folder, false to ignore
 ...
 *
 * @param UtString $path Path to the directory to change to
 * @return UtString The new path. Returns false on failure
 ...
 *
 * @param UtString $regexpPattern Preg_match pattern (Defaults to: .*)
 ...
 *
 * @param UtString $pattern Preg_match pattern (Defaults to: .*)
 * @param boolean $sort Whether results should be sorted.
 ...
 *
 * @param UtString $pattern Pattern to match against
 * @param boolean $sort Whether results should be sorted.
 * @return array Files matching pattern
 */
 ...
 *
 * @param UtString $path Path to check
 ...
 *
 * @param UtString $path Path to check
 * @return UtString Set of slashes ("\\" or "/")
 ...
 *
 * @param UtString $path Path to check
 * @return UtString Path with ending slash
 ...
 *
 * @param UtString $path Path
 * @param UtString $element Element to and at end of path
 * @return UtString Combined path
 ...
 *
 * @param UtString $path The path to check.
 * @return boolean
 ...
 *
 * @param UtString $path The path to check that the current pwd() resides with in.
 ...
 *
 * @param UtString $path The path to chmod
 ...
 *
 * @param UtString $path the directory path to build the tree from
 * @param array|boolean $exceptions Either an array of files/folder to exclude
 *   or boolean true to not grab dot files/folders
 * @param UtString $type either 'file' or 'dir'. null returns both files and directories
 ...
 *
 * @param UtString $pathname The directory structure to create
 * @param integer $mode octal value 0755
 * @return boolean Returns TRUE on success, FALSE on failure
 ...
 *
 * @param UtString $path Path of directory to delete
 ...
 *
 * @param array|UtString $options Either an array of options (see above) or a string of the destination directory.
 * @return boolean Success
 ...
 *
 * @param UtString $path Path to resolve
 * @return UtString The resolved path
