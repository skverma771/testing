	...
	public static function trace($options = array()) {
		...
		for ($i = $options['start']; $i < $count && $i < $options['depth']; $i++) {
			...
			if ($options['format'] == 'points' && $trace['file'] != '[internal]') {
				...
				$back[] = UtString::insert($tpl, $trace, array('before' => '{:', 'after' => '}'));
			}
		}
 ...
 * path with 'CORE'.
 *
 * @param UtString $path Path to shorten
 * @return UtString Normalized path
 */
 ...
 * applied.
 *
 * @param UtString $file Absolute path to a PHP file
 ...
 *
 * @param UtString $var Variable to convert
 * @param integer $depth The depth to output to. Defaults to 3.
 * @return UtString Variable as a formatted string
 ...
 * @return UtString The dumped variable.
 */
 ...
 * @param integer $indent The current indentation level.
 * @return UtString Exported array.
 */
 ...
 *
 * @param UtString $var Object to convert
 ...
 *
 * @param UtString $format The format you want errors to be output as.
 ...
 *
 * @param UtString $format Format to use, including 'js' for JavaScript-enhanced HTML, 'html' for
	...
	public function outputError($data) {
		...
		if (isset($tpl['links'])) {
			foreach ($tpl['links'] as $key => $val) {
				$links[$key] = UtString::insert($val, $data, $insertOpts);
			}
		}
		...
		foreach ($infoData as $key => $value) {
			...
			$info .= UtString::insert($tpl[$key], array($key => $value) + $data, $insertOpts);
		}
		$links = join(' ', $links);
		...
		echo UtString::insert($tpl['error'], compact('links', 'info') + $data, $insertOpts);
	}
 ...
 * @return UtString The type of variable.
 */
