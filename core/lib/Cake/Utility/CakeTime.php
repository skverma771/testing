 ...
 *
 * @param UtString $format Format with specifiers for strftime function.
 *    Accepts the special specifier %S which mimics the modifier S for date()
 * @param UtString $time UNIX timestamp
 * @return UtString windows safe and date() function compatible format for strftime
 ...
 * @return UtString converted element
 */
 ...
 *
 * @param UtString $serverTime UNIX timestamp
 * @param UtString|DateTimeZone $timezone User's timezone string or DateTimeZone object
 ...
 *
 * @param UtString|DateTimeZone $timezone Timezone string or DateTimeZone object
 ...
 *
 * @param integer|UtString|DateTime $dateString UNIX timestamp, strtotime() valid string or DateTime object
 * @param UtString|DateTimeZone $timezone Timezone string or DateTimeZone object
 * @return UtString Parsed timestamp
 * @link http://book.cakephp.org/2.0/en/core-libraries/helpers/time.html#formatting
 */
 ...
 * @param integer|UtString|DateTime $dateString UNIX timestamp, strtotime() valid string or DateTime object
 * @param UtString|DateTimeZone $timezone Timezone string or DateTimeZone object
 * @param UtString $format The format to use. If null, `TimeHelper::$niceFormat` is used
 * @return UtString Formatted date string
 * @link http://book.cakephp.org/2.0/en/core-libraries/helpers/time.html#formatting
 */
 ...
 * @param integer|UtString|DateTime $dateString UNIX timestamp, strtotime() valid string or DateTime object
 * @param UtString|DateTimeZone $timezone Timezone string or DateTimeZone object
 * @return UtString Described, relative date string
 * @link http://book.cakephp.org/2.0/en/core-libraries/helpers/time.html#formatting
 */
 ...
 *
 * @param integer|UtString|DateTime $begin UNIX timestamp, strtotime() valid string or DateTime object
 * @param integer|UtString|DateTime $end UNIX timestamp, strtotime() valid string or DateTime object
 * @param UtString $fieldName Name of database field to compare with
 * @param UtString|DateTimeZone $timezone Timezone string or DateTimeZone object
 * @return UtString Partial SQL string.
 * @link http://book.cakephp.org/2.0/en/core-libraries/helpers/time.html#formatting
 */
 ...
 * @param integer|UtString|DateTime $dateString UNIX timestamp, strtotime() valid string or DateTime object
 * @param UtString|DateTimeZone $timezone Timezone string or DateTimeZone object
 * @param UtString $format date format string
 ...
 *
 * @param UtString $dateString Datetime string or Unix timestamp
 * @param UtString|DateTimeZone $timezone Timezone string or DateTimeZone object
 * @return UtString Formatted date string
 * @link http://book.cakephp.org/2.0/en/core-libraries/helpers/time.html#formatting
 */
 ...
 *
 * @param integer|UtString|DateTime $dateTime Datetime UNIX timestamp, strtotime() valid string or DateTime object
 * @param array $options Default format if timestamp is used in $dateString
 * @return UtString Relative time string.
 * @link http://book.cakephp.org/2.0/en/core-libraries/helpers/time.html#formatting
 */
 ...
 *
 * @param UtString|integer $timeInterval the numeric value with space then time type.
 ...
 *	}}}
 *
 * @param integer|UtString|DateTime $date UNIX timestamp, strtotime() valid string or DateTime object (or a date format string)
 * @param integer|UtString|DateTime $format date format string (or UNIX timestamp, strtotime() valid string or DateTime object)
 * @param boolean|UtString $default if an invalid date is passed it will output supplied default value. Pass false if you want raw conversion value
 * @param UtString|DateTimeZone $timezone Timezone string or DateTimeZone object
 * @return UtString Formatted date string
 * @link http://book.cakephp.org/2.0/en/core-libraries/helpers/time.html#formatting
 */
 ...
 *
 * @param integer|UtString|DateTime $date UNIX timestamp, strtotime() valid string or DateTime object
 * @param UtString $format strftime format string.
 * @param boolean|UtString $default if an invalid date is passed it will output supplied default value. Pass false if you want raw conversion value
 * @param UtString|DateTimeZone $timezone Timezone string or DateTimeZone object
 * @return UtString Formatted and translated date string
 * @link http://book.cakephp.org/2.0/en/core-libraries/helpers/time.html#formatting
 */
 ...
 *
 * @param integer|UtString $filter A regex to filter identifer
 * 	Or one of DateTimeZone class constants (PHP 5.3 and above)
 * @param UtString $country A two-letter ISO 3166-1 compatible country code.
 ...
 *
 * @param UtString $format Format string.
 * @param integer $date Timestamp to format.
 * @return UtString formatted string with correct encoding.
 */
