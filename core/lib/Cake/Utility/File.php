 ...
 * Constructor
 *
 * @param UtString $path Path to file
 ...
 *
 * @param UtString $mode A valid 'fopen' mode string (r|w|a ...)
 ...
 *
 * @param UtString $bytes where to start
 * @param UtString $mode A `fread` compatible mode.
 * @param boolean $force If true then the file will be re-opened even if its already opened, otherwise it won't
 ...
 *
 * @param UtString $data Data to prepare for writing.
 * @param boolean $forceWindows
 * @return UtString The with converted line endings.
 ...
 *
 * @param UtString $data Data to write to this File.
 * @param UtString $mode Mode of writing. {@link http://php.net/fwrite See fwrite()}.
 * @param UtString $force force the file to open
 * @return boolean Success
 ...
 *
 * @param UtString $data Data to write
 * @param UtString $force force the file to open
 * @return boolean Success
 ...
 *
 * @return UtString The File extension
 ...
 *
 * @return UtString The File name without extension.
 ...
 *
 * @param UtString $name The name of the file to make safe if different from $this->name
 * @param UtString $ext The name of the extension to make safe if different from $this->ext
 * @return UtString $ext the extension of the file
 ...
 * @return UtString md5 Checksum {@link http://php.net/md5_file See md5_file()}
 ...
 *
 * @return UtString Full path to file
 ...
 *
 * @return UtString Permissions for the file
 ...
 *
 * @param UtString $dest destination for the copy
 ...
 *
 * @return false|UtString The mimetype of the file, or false if reading fails.
 */
