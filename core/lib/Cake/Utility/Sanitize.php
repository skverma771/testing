 ...
 *
 * @param UtString $string String to sanitize
 * @param array $allowed An array of additional characters that are not to be removed.
 * @return UtString Sanitized string
 */
 ...
 *
 * @param UtString $string String to sanitize
 * @param UtString $connection Database connection being used
 * @return UtString SQL safe string
 */
 ...
 *
 * @param UtString $string String from where to strip tags
 ...
 *
 * @param UtString $str String to sanitize
 * @return UtString whitespace sanitized string
 */
 ...
 *
 * @param UtString $str String to sanitize
 * @return UtString Sting with images stripped.
 */
 ...
 *
 * @param UtString $str String to sanitize
 * @return UtString String with <script>, <style>, <link>, <img> elements removed.
 */
 ...
 *
 * @param UtString|array $data Data to sanitize
 * @param UtString|array $options If string, DB connection being used, otherwise set of options
