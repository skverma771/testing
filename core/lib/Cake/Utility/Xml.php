 ...
 *
 * @param UtString|array $input XML string, a path to a file, an URL or an array
 ...
 * @param UtString $format Either 'attribute' or 'tags'.  This determines where nested keys go.
 * @return void
 * @throws XmlException
 */
 ...
 * @param UtString $ns Namespace of current child
