 ...
 * @return UtString Human readable size
 ...
 * @param float $number A floating point number
 * @param integer $precision The precision of the returned number
 * @return UtString Percentage string
 ...
 * @return UtString formatted number
 ...
 * @param UtString $decimals
 * @param UtString $thousands
 * @return UtString
 */
 ...
 *
 * @param float $number
 * @param UtString $currency Shortcut to default options. Valid values are
 *   'USD', 'EUR', 'GBP', otherwise set at least 'before' and 'after' options.
 * @param array $options
 * @return UtString Number formatted as a currency.
 ...
 *
 * @param UtString $formatName The format name to be used in the future.
