 ...
 * a loaded object.
 *
 * @param UtString $name Name of object to load.
 ...
 *
 *
 * @param UtString $callback|CakeEvent Method to fire on all the objects. Its assumed all the objects implement
 ...
 *
 * @param UtString $name Name of property to read
 * @return mixed
 */
 ...
 *
 * @param UtString $name Name of object being checked.
 * @return boolean
 */
 ...
 *
 * @param UtString|array $name CamelCased name of the object(s) to enable (string or array)
 ...
 * callable as normal.
 *
 * @param UtString|array $name CamelCased name of the objects(s) to disable (string or array)
 * @return void
 */
 ...
 *
 * @param UtString $name Optional.  The name of the object to check the status of.  If omitted,
 ...
 *
 * @param UtString $name Optional.  The name of the behavior to check the status of.  If omitted,
 ...
 *
 * @param UtString $name Name of the object to delete.
 * @return void
 */
 ...
 *
 * @param UtString $name Name of the object
