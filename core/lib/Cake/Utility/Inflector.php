 ...
 *
 * @param UtString $type Inflection type
 * @param UtString $key Original value
 * @param UtString $value Inflected value
 * @return UtString Inflected value, from cache
 */
 ...
 * }}}
 *
 * @param UtString $type The type of inflection, either 'plural', 'singular' or 'transliteration'
 ...
 *
 * @param UtString $word Word in singular
 * @return UtString Word in plural
 ...
 *
 * @param UtString $word Word in plural
 * @return UtString Word in singular
 ...
 *
 * @param UtString $lowerCaseAndUnderscoredWord Word to camelize
 * @return UtString Camelized word. LikeThis.
 ...
 *
 * @param UtString $camelCasedWord Camel-cased word to be "underscorized"
 * @return UtString Underscore-syntaxed version of the $camelCasedWord
 ...
 *
 * @param UtString $lowerCaseAndUnderscoredWord String to be made more readable
 * @return UtString Human-readable string
 ...
 *
 * @param UtString $className Name of class to get database table name for
 * @return UtString Name of the database table for given class
 ...
 *
 * @param UtString $tableName Name of database table to get class name for
 * @return UtString Class name
 ...
 * @return UtString in variable form
 ...
 *
 * @param UtString $string the string you want to slug
 * @param UtString $replacement will replace keys in map
 * @return UtString
