 ...
 *
 * @param UtString|array $check Value to check
 ...
 *
 * @param UtString $check Value to check for length
 ...
 *
 * @param UtString|array $check credit card number to validate
 * @param UtString|array $type 'all' may be passed as a sting, defaults to fast which checks format of most major credit cards
 *    if an array is used only the values of the array are checked.
 *    Example: array('amex', 'bankcard', 'maestro')
 * @param boolean $deep set to true this will check the Luhn algorithm of the credit card.
 * @param UtString $regex A custom regex can also be passed, this will be used instead of the defined regex values
 * @return boolean Success
 * @see Validation::luhn()
 */
 ...
 *
 * @param UtString|array $check1 if string is passed for a string must also be passed for $check2
 *    used as an array it must be passed as array('check1' => value, 'operator' => 'value', 'check2' -> value)
 * @param UtString $operator Can be either a word or operand
 ...
 *
 * @param UtString|array $check When used as a string, $regex must also be a valid regular expression.
 *								As and array: array('check' => value, 'regex' => 'valid regular expression')
 * @param UtString $regex If $check is passed as a string, $regex must also be set to valid regular expression
 * @return boolean Success
 */
 ...
 *
 * @param UtString $check a valid date string
 * @param UtString|array $format Use a string or an array of the keys below. Arrays should be passed as array('dmy', 'mdy', etc)
 ...
 * @param UtString $regex If a custom regular expression is used this is the only validation that will occur.
 * @return boolean Success
 */
 ...
 * @param UtString|array $dateFormat Format of the date part
 ...
 *	- My December 2006 or Dec 2006
 * 	- my 12/2006 separators can be a space, period, dash, forward slash
 * @param UtString $regex Regex for the date part. If a custom regular expression is used this is the only validation that will occur.
 ...
 *
 * @param UtString $check a valid time string
 * @return boolean Success
 */
 ...
 *
 * @param UtString $check a valid boolean
 * @return boolean Success
 */
 ...
 *
 * @param UtString $check Value to check
 * @param boolean $deep Perform a deeper validation (if true), by also checking availability of host
 * @param UtString $regex Regex to use (if none it will use built in regex)
 * @return boolean Success
 */
 ...
 *
 * @param UtString $check The string to test.
 * @param UtString $type The IP Protocol version to validate against
 * @return boolean Success
 */
 ...
 *
 * @param UtString $check Value to check
 * @param UtString $symbolPosition Where symbol is located (left/right)
 * @return boolean Success
 */
 ...
 *
 * @param UtString|array $check Value to check (string or array)
 * @param UtString $regex Regular expression to use
 * @param UtString $country Country code (defaults to 'all')
 * @return boolean Success
 */
 ...
 * @param UtString|array $check Value to check
 * @param UtString $regex Regular expression to use
 * @param UtString $country Country to use for formatting
 * @return boolean Success
 */
 ...
 * @param UtString|array $check Value to check
 * @param UtString $regex Regular expression to use
 * @param UtString $country Country
 * @return boolean Success
 */
 ...
 *
 * @param UtString|array $check value that will be validated in user-defined methods.
 * @param CakeObject $object class that holds validation method
 * @param UtString $method class method name for validation to run
 ...
 * `NlValidation`.
 *
 * @param UtString $method The method to call on the other class.
 * @param mixed $check The value to check or an array of parameters for the method to be called.
 * @param UtString $classPrefix The prefix for the class to do the validation.
 ...
 *
 * @param UtString $check Value to check against the $regex expression
 * @param UtString $regex Regular expression
