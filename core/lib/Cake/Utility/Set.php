 ...
 *
 * @param UtString $class A class name of the type of object to map to
 * @param UtString $tmp A temporary class name used as $class if $class is an array
 ...
 * @param UtString $class Class name
 ...
 * @param array|UtString $list can be an array or a comma-separated list.
 * @return UtString the value of the array key or null if no match
 ...
 * @param UtString $format Format string into which values will be inserted, see sprintf()
 ...
 *
 * @param UtString $path An absolute XPath 2.0 path
 ...
 *
 * @param UtString|array $conditions An array of condition strings or an XPath expression
 ...
 * @param UtString|array $path As an array, or as a dot-separated string.
 ...
 * @param UtString $path A dot-separated string.
 ...
 *
 * @param UtString|array $data Data to check on
 * @param UtString|array $path A dot-separated string.
 ...
 * @param UtString $sep If $list is a string, it will be split into an array with $sep
 ...
 *
 * @param array|CakeObject $data Array or object from where to extract keys and values
 * @param UtString|array $path1 As an array, or as a dot-separated string.
 * @param UtString|array $path2 As an array, or as a dot-separated string.
 * @param UtString $groupPath As an array, or as a dot-separated string.
 * @return array Combined array
 ...
 * @param UtString $separator String used to separate array key elements in a path, defaults to '.'
 * @return array
 ...
 * @param UtString $separator The delimiter used
 * @return array
 */
 ...
 * @param UtString $path A Set-compatible path to the array value
 * @param UtString $dir Direction of sorting - either ascending (ASC), or descending (DESC)
 ...
 * @param UtString|array $path string or array of array keys
