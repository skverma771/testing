 ...
 * @param UtString|array $path The path being searched for. Either a dot
 ...
 * @param UtString $path The path to extract.
 ...
 *
 * @param UtString $key The key in the array being searched.
 * @param UtString $token The token being matched.
 * @return boolean
 */
 ...
 * @param UtString $selector The patterns to match.
 ...
 * @param UtString $path The path to insert at.
 ...
 *
 * @param UtString $op The operation to do.
 ...
 *
 * @param array $data The data to operate on
 * @param UtString $path A path expression to use to remove.
 ...
 * @param UtString $keyPath A dot-separated string.
 * @param UtString $valuePath A dot-separated string.
 * @param UtString $groupPath A dot-separated string.
 ...
 * @param UtString $paths An array containing one or more Hash::extract()-style key paths
 ...
 * @param UtString $path The path to check for.
 ...
 * @param UtString $path The path to extract for mapping over.
 ...
 * @param UtString $path The path to extract from $data.
 ...
 * @param UtString $dir See directions above.
 * @param UtString $type See direction types above. Defaults to 'regular'.
 ...
 * @param UtString $key The key for the data.
 * @return array
 */
