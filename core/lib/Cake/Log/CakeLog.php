 ...
 *
 * @param UtString $key The keyname for this logger, used to remove the
 *    logger later.
 ...
 *
 * @param UtString $streamName Key name of a configured stream to remove.
 * @return void
 */
 ...
 *
 * @param UtString $streamName to check
 * @return bool
 * @throws CakeLogException
 */
 ...
 *
 * @param UtString $streamName to enable
 * @return void
 * @throws CakeLogException
 */
 ...
 * its re-enabled.
 *
 * @param UtString $streamName to disable
 * @return void
 * @throws CakeLogException
 */
 ...
 *
 * @param UtString $streamName Key name of a configured stream to get.
 ...
 *
 * @param integer|UtString $type Type of message being written. When value is an integer
 *    or a string matching the recognized levels, then it will
 *    be treated log levels. Otherwise it's treated as scope.
 * @param UtString $message Message content to log
 * @param UtString|array $scope The scope(s) a log messge is being created in.
 ...
 *
 * @param UtString $message log message
 * @param UtString|array $scope The scope(s) a log messge is being created in.
 *    See CakeLog::config() for more information on logging scopes.
 * @return boolean Success
 */
