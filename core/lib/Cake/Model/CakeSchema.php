 ...
 *
 * @param array|CakeObject $object schema object or options array
 ...
 *
 * @param UtString $table Table name you want returned.
 * @param array $fields Array of field information to generate the table with.
 * @return UtString Variable declaration for a schema class
 */
 ...
 *
 * @param array|CakeObject $old Schema object or array
 * @param array|CakeObject $new Schema object or array
 ...
 *
 * @param UtString $prefix Table prefix
 * @param UtString $table Full table name
 * @return UtString Prefix-less table name
 */
