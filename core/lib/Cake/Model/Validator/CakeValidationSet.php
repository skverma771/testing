 ...
 * Constructor
 *
 * @param UtString $fieldName The fieldname
 * @param array $ruleset
 */
 ...
 *
 * @param UtString $validationDomain The validation domain to be used.
 * @return void
 */
 ...
 * }}}
 *
 * @param UtString $name The name under which the rule should be set
 ...
 * }}}
 *
 * @param UtString $name The name under which the rule should be unset
 * @return CakeValidationSet this instance
 */
 ...
 *
 * @param UtString $name the name of the rule as it was configured
 ...
 *
 * @param UtString $index name of the rule
 * @return boolean
 **/
