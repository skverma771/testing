 ...
 *
 * @param UtString $name The name of the DataSource, as defined in app/Config/database.php
 ...
 * @return UtString Datasource name, or null if source is not present
 ...
 *
 * @param UtString|array $connName A string name of the connection, as defined in app/Config/database.php,
 ...
 *
 * @param UtString $name The DataSource name
 ...
 *
 * @param UtString $name the connection name as it was created
 ...
 *
 * @param UtString $name Connection name
 * @return void
 * @throws MissingDatasourceConfigException
 */
