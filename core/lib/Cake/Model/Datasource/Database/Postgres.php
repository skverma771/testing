 ...
 *
 * @param Model|UtString $model Name of database table to inspect
 ...
 *
 * @param UtString $source Name of the database table
 * @param UtString $field Name of the ID database field. Defaults to "id"
 * @return integer
 */
 ...
 *
 * @param UtString|Model $table Either a full table name (with prefix) as a string, or a model object
 * @param UtString $field Name of the ID database field. Defaults to "id"
 * @return UtString The associated sequence name from the sequence map, defaults to "{$table}_{$field}_seq"
 */
 ...
 *
 * @param UtString|Model $table A string or model class representing the table to be truncated
 ...
 * @param UtString $table name of the table
 * @return array
 */
 ...
 *
 * @param UtString $table Table to alter indexes for
 ...
 * @return UtString Abstract column type (i.e. "string")
 */
 ...
 *
 * @return UtString The database encoding
 */
 ...
 *
 * @return UtString The schema name
 */
