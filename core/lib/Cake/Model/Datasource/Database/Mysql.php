 ...
 *
 * @param UtString $name Collation name
 * @return UtString Character set name
 */
 ...
 *
 * @param Model|UtString $model Name of database table to inspect or model instance
 ...
 *
 * @param UtString $enc Database encoding
 * @return boolean
 */
 ...
 *
 * @param UtString $table Table to alter parameters for.
 ...
 *
 * @param UtString $name Table name to get parameters
 * @return array Array of table names in the database
 */
