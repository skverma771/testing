 ...
 *
 * @param Model|UtString $model Model object to describe, or a string table name.
 ...
 *
 * @param UtString $type Query type
 ...
 *
 * @param Model|UtString $model Model instance of table name
 * @return UtString
 */
