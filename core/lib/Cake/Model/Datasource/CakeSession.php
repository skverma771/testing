 ...
 * Pseudo constructor.
 *
 * @param UtString $base The base path for the Session
 * @return void
 */
 ...
 *
 * @param UtString $name Variable name to check for
 ...
 *
 * @param UtString $name Session variable to remove
 ...
 * @return UtString Error as string
 */
 ...
 *
 * @param UtString|array $name The name of the session variable (or a path as sent to Set.extract)
 ...
 *
 * @param UtString|array $name Name of variable
 * @param UtString $value Value to write
 ...
 * @param UtString $errorMessage Description of the error
 * @return void
 */
