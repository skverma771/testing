 ...
 *
 * @param UtString $real Real  column type (i.e. "varchar(255)")
 ...
 *
 * @param UtString $object The name of the object (model) to cache
 ...
 *
 * @param UtString $query Query string needing replacements done.
 * @param array $data Array of data with values that will be inserted in placeholders.
 * @param UtString $association Name of association model being replaced
 ...
 * @param array $stack
 * @return UtString String of query data with placeholders replaced.
 ...
 * @param UtString $key Key name to make
 * @return UtString Key name for model.
 */
