 ...
 *
 * @return UtString The database version
 */
 ...
 *
 * @param UtString $data String to be prepared for use in an SQL statement
 * @param UtString $column The column into which this data will be inserted
 * @return UtString Quoted and escaped data
 */
 ...
 *
 * @param UtString $identifier A SQL expression to be used as an identifier
 ...
 * are not sanitized or escaped.
 *
 * @param UtString $expression An arbitrary SQL expression to be inserted into a query.
 ...
 *
 * @param UtString $sql SQL statement
 ...
 * @return UtString Error message with error number
 */
 ...
 *
 * @param UtString $sql Some SQL to be executed.
 ...
 *
 * @param UtString $name Name of the field
 * @param UtString $sql SQL query
 ...
 *
 * @param UtString $method Name of the method being cached.
 * @param UtString $key The key name for the cache operation.
 ...
 *
 * @param Model|UtString $model Either a Model object or a string table name.
 * @param boolean $quote Whether you want the table name quoted.
 * @param boolean $schema Whether you want the schema name included.
 * @return UtString Full quoted table name
 */
 ...
 * @param UtString $type Association type, one of the model association types ie. hasMany
 * @param UtString $association
 ...
 *
 * @param Model $model Primary model object
 * @param UtString $query Association query
 ...
 * @param UtString $association Name of Model being Merged
 ...
 *
 * @param UtString $type Association type
 * @param Model $model Model object
 * @param UtString $linkModel
 * @param UtString $alias
 * @param array $assoc
 * @param UtString $alias2
 ...
 * @return UtString An SQL JOIN statement to be used in a query
 ...
 * @return UtString An executable SQL statement
 ...
 *
 * @param UtString $type type of query being run.  e.g select, create, update, delete, schema, alter.
 * @param array $data Array of data to insert into the query.
 * @return UtString Rendered SQL expression to be run.
 */
 ...
 *
 * @param Model $model
 * @param UtString $func Lowercase name of SQL function, i.e. 'count' or 'max'
 * @param array $params Function parameters (any values must be quoted manually)
 * @return UtString An SQL calculation function
 */
 ...
 *
 * @param Model|UtString $table A string or model class representing the table to be truncated
 ...
 *
 * @param Model $model
 * @param UtString|array|boolean $conditions Array of conditions, conditions string, null or false. If an array of conditions,
 ...
 *
 * @param Model $model
 * @param UtString $alias Alias table name
 ...
 */
	public function fields(Model $model, $alias = null, $fields = array(), $quote = true) {
		...
		if ($allFields) {
			...
			$fields = UtString::tokenize($fields);
		}
 ...
 * @param UtString $key An SQL key snippet containing a field and optional SQL operator
 ...
 */
	protected function _parseKey($model, $key, $value) {
		...
		if ($bound) {
			return UtString::insert($key . ' ' . trim($operator), $value);
		}
 ...
 * Quotes Model.fields
 *
 * @param UtString $conditions
 * @return UtString or false if no match
 */
 ...
 *
 * @param UtString $match matched string
 * @return UtString quoted string
 */
 ...
 * @return UtString SQL limit/offset statement
 */
 ...
 *
 * @param array|UtString $keys Field reference, as a key (i.e. Post.title)
 * @param UtString $direction Direction (ASC or DESC)
 * @param Model $model model reference (used to look for virtual field)
 * @return UtString ORDER BY clause
 */
 ...
 *
 * @param UtString $group Group By Condition
 * @param Model $model
 * @return UtString string condition or null
 */
 ...
 * @param UtString $sql SQL WHERE clause (condition only, not the "WHERE" part)
 ...
 *
 * @param UtString $real Real database-layer column type (i.e. "varchar(255)")
 ...
 * @param boolean $quote
 * @return UtString|boolean Converted boolean value
 */
 ...
 *
 * @param UtString $table The table being inserted into.
 ...
 *
 * @param UtString $model Name of model to inspect
 ...
 * @param UtString $tableName Optional.  If specified only the table name given will be generated.
 ...
 * @param UtString $table Optional.  If specified only the table name given will be generated.
 *   Otherwise, all tables defined in the schema are generated.
 * @return UtString
 */
 ...
 *
 * @param UtString $columnString The partially built column string
 * @param array $columnData The array of column data.
 * @param UtString $position The position type to use. 'beforeDefault' or 'afterDefault' are common
 * @return UtString a built column with the field parameters added.
 */
