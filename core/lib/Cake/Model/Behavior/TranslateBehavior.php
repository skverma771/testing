 ...
 * @param CakeObject $joinTable The jointable object.
 * @param array $query The query array to append a join to.
 * @param UtString $field The field name being joined.
 * @param UtString $aliasField The aliased field name being joined.
 * @param UtString|array $locale The locale(s) having joins added.
 ...
 * @param UtString|array $fields string with field or array(field1, field2=>AssocName, field3)
 ...
 *
 * @param UtString $field The field to update.
 */
 ...
 *
 * @param Model $model instance of model
 * @param UtString|array $fields string with field, or array(field1, field2=>AssocName, field3), or null for
