 ...
 *
 * @param Model $Model Model instance
 * @param integer|UtString|boolean $id The ID of the record to read or false to read all top level nodes
 ...
 * @param UtString|array $fields Either a single string of a field name, or an array of field names
 * @param UtString $order SQL ORDER BY conditions (e.g. "price DESC" or "name ASC") defaults to the tree order
 ...
 *
 * @param Model $Model Model instance
 * @param UtString|array $conditions SQL conditions as a string or as an array('field' =>'value',...)
 * @param UtString $keyPath A string path to the key, i.e. "{n}.Post.id"
 * @param UtString $valuePath A string path to the value, i.e. "{n}.Post.title"
 * @param UtString $spacer The character or characters which will be repeated
 * @param integer $recursive The number of levels deep to fetch associated records
 ...
 *
 * @param Model $Model Model instance
 * @param integer|UtString $id The ID of the record to move
 ...
 *
 * @param Model $Model Model instance
 * @param UtString $mode parent or tree
 * @param UtString|integer $missingParentAction 'return' to do nothing and return, 'delete' to
 ...
 *
 * @param Model $Model Model instance
 * @param integer|UtString $id The ID of the record to remove
 ...
 *
 * @param Model $Model Model instance
 * @param integer|UtString $parentId
 ...
 *
 * @param Model $Model
 * @param UtString $scope
 * @param UtString $right
