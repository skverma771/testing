 ...
 * @param UtString $message Validation message explaining why the rule failed, defaults to true.
 * @return void
 */
 ...
 *
 * @param UtString $name [optional] The fieldname to fetch. Defaults to null.
 ...
 *
 * @param UtString $validationDomain [optional] The validation domain to be used.
 ...
 *
 * @param UtString $field name of the field to check
 * @return boolean
 **/
 ...
 *
 * @param UtString $field name of the field to set
 ...
 *
 * @param UtString $field name of the field to unset
 * @return void
 **/
 ...
 * }}}
 *
 * @param UtString $field The name of the field from wich the rule will be removed
 * @param UtString|array|CakeValidationSet $name name of the rule to be added or list of rules for the field
 ...
 *
 * @param UtString $field The name of the field from wich the rule will be removed
 * @param UtString $rule the name of the rule to be removed
 * @return ModelValidator this instance
 **/
