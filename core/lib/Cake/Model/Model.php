 ...
 *
 * @param integer|UtString|array $id Set this ID for this model on startup, can also be an array of options, see above.
 * @param UtString $table Name of database table to use.
 * @param UtString $ds DataSource connection name.
 */
 ...
 *
 * @param UtString $method Name of method to call.
 ...
 *
 * @param UtString $name variable tested for existence in class
 ...
 *
 * @param UtString $name variable requested for it's value or reference
 ...
 *
 * @param UtString $assoc Association name
 * @param UtString $className Class name
 * @param UtString $plugin name of the plugin where $className is located
 ...
 *
 * @param UtString $type 'belongsTo', 'hasOne', 'hasMany', 'hasAndBelongsToMany'
 * @param UtString $assocKey
 * @return void
 */
 ...
 *
 * @param UtString $tableName Name of the custom table
 * @return void
 ...
 *
 * @param UtString|array|SimpleXmlElement|DomNode $one Array or string of data
 * @param UtString $two Value string for the alternative indata method
 ...
 *
 * @param UtString $field The name of the field to be deconstructed
 * @param array|CakeObject $data An array or object to be deconstructed into a field
 ...
 *
 * @param boolean|UtString $field Set to true to reload schema, or a string to return a specific field
 ...
 *
 * @param UtString $column The name of the model column
 * @return UtString Column type
 */
 ...
 *
 * @param UtString|array $name Name of field to look for, or an array of names
 ...
 *
 * @param UtString $method The method to be called.
 ...
 *
 * @param UtString $field Name of field to look for
 ...
 *
 * @param UtString|array $fields String of single field name, or an array of field names.
 * @param integer|UtString $id The ID of the record to read
 ...
 * supplied order.
 *
 * @param UtString $name Name of field to get
 * @param array $conditions SQL conditions (defaults to NULL)
 * @param UtString $order SQL ORDER BY fragment
 * @return UtString field contents, or false if not found
 ...
 * model ID.
 *
 * @param UtString $name Name of the table field
			...
			if (!empty($this->id)) {
				...
				if (empty($this->data[$this->alias][$this->primaryKey]) && $isUUID) {
					if (array_key_exists($this->primaryKey, $this->data[$this->alias])) {
						...
						$values[$j] = UtString::uuid();
					} else {
						list($fields[], $values[]) = array($this->primaryKey, UtString::uuid());
					}
				}
 ...
 * @param integer|UtString $id ID of record in this model
 * @param DataSource $db
 * @return void
 */
 ...
 *
 * @param integer|UtString $id ID of record to delete
 ...
 *
 * @param UtString $id ID of record that was deleted
 * @param boolean $cascade Set to true to delete records that depend on this record
 * @return void
 */
 ...
 *
 * @param integer|UtString $id ID of record to check for existence
 ...
 * @param UtString $type Type of find operation (all / first / count / neighbors / list / threaded)
 ...
 *
 * @param UtString $state Either "before" or "after"
 * @param array $query
 * @param array $results
 * @return array
 * @see Model::find()
		...
		if ($state === 'before') {
			if (empty($query['fields'])) {
				...
				if (!is_array($query['fields'])) {
					$query['fields'] = UtString::tokenize($query['fields']);
				}
 ...
 *
 * @param UtString $options An optional array of custom options to be made available in the beforeValidate callback
 ...
 *
 * @param UtString $field The name of the field to invalidate
 ...
 *
 * @param UtString $field Returns true if the input string ends in "_id"
 ...
 *
 * @param UtString $field Field to escape (e.g: id)
 * @param UtString $alias Alias for the model (e.g: Post)
 * @return UtString The name of the escaped field for this Model (i.e. id becomes `Post`.`id`).
 */
 ...
 *
 * @param integer|UtString $id Last inserted ID
 * @return void
 */
 ...
 *
 * @param UtString $dataSource The name of the DataSource, as defined in app/Config/database.php
 * @return void
 ...
 *
 * @param UtString $type Only result associations of this type
 ...
 *
 * @param UtString|array $assoc The model to be joined
 ...
 *
 * @param UtString $type If null this deletes cached views if Cache.check is true
