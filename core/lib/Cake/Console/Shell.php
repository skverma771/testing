 ...
 *
 * @param UtString $task The task name to check.
 ...
 *
 * @param UtString $name The method name to check.
 * @return boolean
 ...
 *
 * @param UtString $command The command name to run on this shell. If this argument is empty,
 ...
 *
 * @param UtString $prompt Prompt text.
 * @param UtString|array $options Array or string of options.
 * @param UtString $default Default input value.
 ...
 *
 * @param UtString $text Text the text to format.
 * @param UtString|integer|array $options Array of options to use, or an integer to wrap the text to.
 * @return UtString Wrapped / indented text
 * @see UtString::wrap()
 * @link http://book.cakephp.org/2.0/en/console-and-shells.html#Shell::wrapText
 */
	public function wrapText($text, $options = array()) {
		return UtString::wrap($text, $options);
	}
 ...
 *
 * @param UtString|array $message A string or a an array of strings to output
 ...
 *
 * @param UtString $title Title of the error
 * @param UtString $message An optional error message
 * @return void
 ...
 *
 * @param UtString $path Where to put the file.
 * @param UtString $contents Content to put in the file.
 * @return boolean Success
 ...
 *
 * @param UtString $file Absolute file path
 * @return UtString short path
 ...
 *
 * @param UtString $name Controller class name
 * @return UtString Path to controller
 */
 ...
 *
 * @param UtString $name Controller class name
 * @return UtString Controller plural name
 */
 ...
 *
 * @param UtString $name Name
 * @return UtString Camelized and singularized model name
 */
 ...
 *
 * @param UtString $name Model class name
 * @return UtString Singular model key
 */
 ...
 *
 * @param UtString $key Foreign key
 * @return UtString Model name
 */
 ...
 *
 * @param UtString $name Name to use
 * @return UtString Plural name for views
 */
 ...
 *
 * @param UtString $name Controller name
 * @return UtString Singular human name
 */
 ...
 *
 * @param UtString $name Controller name
 * @return UtString Plural human name
 */
 ...
 *
 * @param UtString $pluginName Name of the plugin you want ie. DebugKit
 * @return UtString $path path to the correct plugin.
 */
