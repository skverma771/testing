 ...
 *
 * @param UtString $command The command name this parser is for.  The command name is used for generating help.
 ...
 *
 * @param UtString $text The text to set, or null if you want to read
 ...
 *
 * @param UtString|array $text The text to set, or null if you want to read. If an array the
 ...
 *
 * @param UtString|array $text Text when setting or null when reading. If an array the text will be imploded with "\n"
 ...
 *
 * @param ConsoleInputOption|UtString $name The long name you want to the value to be parsed out as when options are parsed.
 ...
 *   An exception will be raised when parse() encounters an invalid value.
 *
 * @param ConsoleInputArgument|UtString $name The name of the argument.  Will also accept an instance of ConsoleInputArgument
 ...
 *    it will be used.
 *
 * @param ConsoleInputSubcommand|UtString $name Name of the subcommand. Will also accept an instance of ConsoleInputSubcommand
 ...
 * @param UtString $command The subcommand to use.  If this parameter is a subcommand, that has a parser,
 ...
 * in the parser.
 *
 * @param UtString $subcommand If present and a valid subcommand that has a linked parser.
 *    That subcommands help will be shown instead.
 * @param UtString $format Define the output format, can be text or xml
 * @param integer $width The width to format user content to. Defaults to 72
 * @return UtString Generated help.
 */
 ...
 *
 * @param UtString $option The option to parse.
 ...
 *
 * @param UtString $name The name to parse.
 * @param array $params The params to append the parsed value into
 * @return array Params with $option added in.
 ...
 *
 * @param UtString $name The name of the option.
 * @return boolean
 */
 ...
 *
 * @param UtString $argument The argument to append
