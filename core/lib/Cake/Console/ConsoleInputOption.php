 ...
 *
 * @param UtString|array $name The long name of the option, or an array with all the properties.
 * @param UtString $short The short alias for this option
 * @param UtString $help The help text for this option
 * @param boolean $boolean Whether this option is a boolean option.  Boolean options don't consume extra tokens
 * @param UtString $default The default value for this option.
 ...
 *
 * @return UtString Value of this->_name.
 */
 ...
 *
 * @return UtString Value of this->_short.
 */
