 ...
 *
 * @param UtString $class Class name that is being used.
 ...
 *
 * @param UtString $identifier Identifier to parse
 ...
 *
 * @param UtString $class Class type you want (Aro/Aco)
 * @param UtString|array $identifier A mixed identifier for finding the node.
 ...
 *
 * @param UtString $type Node type  (ARO/ACO)
