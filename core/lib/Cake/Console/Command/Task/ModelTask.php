 ...
 *
 * @param UtString $className Name of class you want model to be.
 * @param UtString $table Table name
 ...
 * @param UtString $prompt Prompt to use for options list.
 ...
 *
 * @param UtString $modelName Name of the model relations belong to.
 * @param UtString $type Name of association you want to see. i.e. 'belongsTo'
 * @param UtString $associations Collection of associations.
 * @return void
 */
 ...
 * @return UtString Name of field that is a primary key.
 */
 ...
 *
 * @param UtString $fieldName Name of field to be validated.
 * @param array $metaData metadata for field
 * @param UtString $primaryKey
 ...
 *
 * @param UtString|CakeObject $name Model name or object
 ...
 *
 * @param UtString $className Model class name
 * @return UtString
 */
 ...
 *
 * @param UtString $useDbConfig Database configuration name
 * @return array
 */
 ...
 *
 * @param UtString $modelName Name of the model you want a table for.
 * @param UtString $useDbConfig Name of the database config you want to get tables from.
 * @return UtString Table name
 */
 ...
 *
 * @param UtString $useDbConfig Connection name to scan.
 ...
 *
 * @param UtString $useDbConfig Database config name
 * @return UtString the model name
 */
 ...
 *
 * @param UtString $className Name of class to bake fixture for
 * @param UtString $useTable Optional table name for fixture to use.
 * @return void
