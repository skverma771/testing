 ...
 *
 * @param UtString $controllerName
 * @param UtString $useDynamicScaffold
 * @param array $helpers
 ...
 *
 * @param UtString $controllerName Controller name
 * @param UtString $admin Admin route to use
 * @param boolean $wannaUseSession Set to true to use sessions, false otherwise
 * @return UtString Baked actions
 */
 ...
 *
 * @param UtString $controllerName Controller name already pluralized and correctly cased.
 * @param UtString $actions Actions to add, or set the whole controller to use $scaffold (set $actions to 'scaffold')
 * @param array $helpers Helpers to use in controller
 * @param array $components Components to use in controller
 * @return UtString Baked controller
 */
 ...
 *
 * @param UtString $className Controller class name
 * @return UtString Baked test
 */
 ...
 *
 * @param UtString $prompt A yes/no question to precede the list
 * @param UtString $example A question for a comma separated list, with examples.
 ...
 *
 * @param UtString $useDbConfig Connection name to get a controller name for.
 * @return UtString Controller name
 */
