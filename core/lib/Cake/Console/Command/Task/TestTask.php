 ...
 *
 * @param UtString $type Type of object to bake test case for ie. Model, Controller
 * @param UtString $className the 'cake name' for the class ie. Posts for the PostsController
 * @return UtString|boolean
 */
 ...
 *
 * @return UtString Users chosen type.
 */
 ...
 *
 * @param UtString $objectType Type of object to list classes for i.e. Model, Controller.
 * @return UtString Class name the user chose.
 */
 ...
 *
 * @param UtString $type The Type of object you are generating tests for eg. controller
 * @return boolean
 */
 ...
 *
 * @param UtString $package The package of object you are generating tests for eg. controller
 * @param UtString $class the Classname of the class the test is being generated for.
 * @return boolean
 */
 ...
 * @param UtString $type The Type of object you are generating tests for eg. controller
 * @param UtString $class the Classname of the class the test is being generated for.
 * @return UtString Real classname
 */
 ...
 *
 * @param UtString $type The type of thing having a test generated.
 * @param UtString $plugin The plugin name.
 * @return UtString
 ...
 *
 * @param UtString $className Name of class to look at.
 ...
 *
 * @param UtString $name Name of the Model class that a fixture might be required for.
 * @return void
 */
 ...
 *
 * @param UtString $type The type of object tests are being generated for eg. controller.
 * @return boolean
 */
 ...
 *
 * @param UtString $type The Type of object you are generating tests for eg. controller
 * @param UtString $fullClassName The Classname of the class the test is being generated for.
 * @param UtString $plugin The plugin name.
 ...
 *
 * @param UtString $type The Type of object you are generating tests for eg. controller
 * @param UtString $realType The package name for the class.
 * @param UtString $className The Classname of the class the test is being generated for.
 ...
 * @param UtString $type The Type of object you are generating tests for eg. controller
 * @param UtString $className the Classname of the class the test is being generated for.
 * @return UtString filename the test should be created on.
 */
