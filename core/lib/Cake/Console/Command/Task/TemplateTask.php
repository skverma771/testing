 ...
 * Runs the template
 *
 * @param UtString $directory directory / type of thing you want
 * @param UtString $filename template name
 * @param array $vars Additional vars to set to template scope.
 * @return UtString contents of generated code template
 */
 ...
 *
 * @return UtString returns the path to the selected theme.
 */
 ...
 *
 * @param UtString $path The initial path to look for the file on. If it is not found fallbacks will be used.
 * @param UtString $directory Subdirectory to look for ie. 'views', 'objects'
 * @param UtString $filename lower_case_underscored filename you want.
 * @return UtString filename will exit program if template is not found.
 */
