 ...
 *
 * @param UtString $modelName Name of model you are dealing with.
 ...
 *
 * @param UtString $model Name of model to bake.
 * @param UtString $useTable Name of table to use.
 * @param array $importOptions Options for public $import
 * @return UtString Baked fixture content
 */
 ...
 *
 * @param UtString $model name of the model being generated
 * @param UtString $otherVars Contents of the fixture file.
 * @return UtString Content saved into fixture file.
 */
 ...
 *
 * @return UtString Path for the fixtures
 */
 ...
 * @return UtString fields definitions
 */
 ...
 * @return UtString A string value of the $records array.
 */
 ...
 * to build a fixture.
 *
 * @param UtString $modelName name of the model to take records from.
 * @param UtString $useTable Name of table to use.
