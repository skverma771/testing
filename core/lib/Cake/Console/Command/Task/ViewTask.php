 ...
 *
 * @param UtString $action Action to bake
 * @param UtString $content Content to write
 ...
 *
 * @param UtString $action name to generate content to
 * @param array $vars passed for use in templates
 * @return UtString content from template
 */
 ...
 *
 * @param UtString $action name
 * @return UtString template name
 */
