 ...
 *
 * @param UtString $path Project path
 * @param UtString $skel Path to copy from
 * @param UtString $skip array of directories to skip when copying
 * @return mixed
 */
		...
		switch (strtolower($looksGood)) {
			case 'y':
				...
				foreach ($Folder->messages() as $message) {
					$this->out(UtString::wrap(' * ' . $message), 1, Shell::VERBOSE);
				}
 ...
 *
 * @param UtString $filename The filename to operate on.
 ...
 *
 * @param UtString $name Name to use as admin routing
 * @return boolean Success
 */
 ...
 *
 * @return UtString Admin route to use
 */
