 ...
 *
 * @param UtString $domain
 * @param UtString $msgid
 * @param array $details
 */
 ...
 * Parse tokens
 *
 * @param UtString $functionName Function name that indicates translatable string (e.g: '__')
 ...
 *
 * @param UtString $field the name of the field that is being processed
 * @param array $rules the set of validation rules for the field
 * @param UtString $file the file name where this validation rule was found
 * @param UtString $domain default domain to bind the validations to
 * @return void
 */
 ...
 *
 * @param UtString $domain
 * @param UtString $header
 * @param UtString $sentence
 * @return void
 */
 ...
 *
 * @return UtString Translation template header
 */
 ...
 *
 * @param UtString $string String to format
 * @return UtString Formatted string
 */
 ...
 *
 * @param UtString $file File where invalid marker resides
 * @param integer $line Line number
 * @param UtString $marker Marker found
