 ...
 *
 * @param UtString $stream The identifier of the stream to write output to.
 */
 ...
 *
 * @param UtString $text Text with styling tags.
 * @return UtString String with color codes added.
 */
 ...
 *
 * @param UtString $message Message to write.
 ...
 *
 * @param UtString $style The style to get or create.
