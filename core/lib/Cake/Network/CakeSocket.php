 ...
 * @param UtString $errStr Error string
 * @return void
 */
 ...
 *
 * @param UtString $data The data to write to the socket
 * @return boolean Success
 */
