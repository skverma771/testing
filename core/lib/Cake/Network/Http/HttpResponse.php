 ...
 *
 * @param UtString $name Header name
 * @param array $headers
 ...
 *
 * @param UtString $message Message to parse
 * @return void
 ...
 *
 * @param UtString $body A string containing the body to decode.
 * @param UtString|boolean $encoding Can be false in case no encoding is being used, or a string representing the encoding.
 ...
 * a result.
 *
 * @param UtString $body A string containing the chunked body to decode.
 * @return mixed Array of response headers and body or false.
 * @throws SocketException
 */
 ...
 *
 * @param UtString $token Token to unescape
 * @param array $chars
 * @return UtString Unescaped token
