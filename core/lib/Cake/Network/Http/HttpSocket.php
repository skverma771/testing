 ...
 *
 * @param UtString|array $config Configuration information, either a string url or an array of options.
 */
 ...
 * `$http->configAuth();`
 *
 * @param UtString $method Authentication method (ie. Basic, Digest). If empty, disable authentication
 * @param UtString|array $user Username for authentication. Can be an array with settings to authentication class
 * @param UtString $pass Password for authentication
 * @return void
 */
 ...
 * Set proxy settings
 *
 * @param UtString|array $host Proxy host. Can be an array with settings to authentication class
 * @param integer $port Port. Default 3128.
 * @param UtString $method Proxy method (ie, Basic, Digest). If empty, disable proxy authentication
 * @param UtString $user Username if your proxy need authentication
 * @param UtString $pass Password to proxy authentication
 * @return void
 */
 ...
 *
 * @param UtString|array $request Either an URI string, or an array defining host/uri
 ...
 * }}}
 *
 * @param UtString|array $uri URI to request. Either a string uri, or a uri array, see HttpSocket::_parseUri()
 ...
 * }}}
 *
 * @param UtString|array $uri URI to request. See HttpSocket::_parseUri()
 ...
 *
 * @param UtString|array $uri URI to request (see {@link _parseUri()})
 ...
 *
 * @param UtString|array Either a string or array of url options to create a url with.
 * @param UtString $uriTemplate A template string to use for url formatting.
 ...
 *
 * @param UtString|array $uri URI, See HttpSocket::_parseUri()
 ...
 *
 * @param UtString|array $uri Either A $uri array, or a request string. Will use $this->config if left empty.
 * @param UtString $uriTemplate The Uri template/format to use.
 ...
 *
 * @param UtString|array $uri URI to parse
 ...
 *
 * @param UtString|array $query A query string to parse into an array or an array to return directly "as is"
 ...
 * @param UtString $versionToken The version token to use, defaults to HTTP/1.1
 * @return UtString Request line
 * @throws SocketException
 */
 ...
 * @param UtString $mode
 * @return UtString Header built from array
 */
 ...
 * @return UtString Cookie header string to be sent with the request.
 ...
 *
 * @param UtString $token Token to escape
 * @param array $chars
 * @return UtString Escaped token
