 ...
 * Constructor
 *
 * @param UtString $url Trimmed url string to use.  Should not contain the application base path.
 ...
 *
 * @return UtString URI The CakePHP request path that is being accessed.
 */
 ...
 *
 * @param UtString $path The dot separated path to insert $data into.
 * @param array $data The data to traverse/insert.
 * @param UtString $field The terminal field name, which is the top level key in $_FILES.
 * @return void
 */
 ...
 * @return UtString The referring address for this request.
 */
 ...
 *
 * @param UtString $name The method called
 ...
 *
 * @param UtString $name The property being accessed.
 ...
 *
 * @param UtString $type The type of request you want to check.
 ...
 *
 * @param UtString $name The name of the detector.
 ...
 * @return UtString the current request url including query string args.
 */
 ...
 *
 * @param UtString $name Name of the header you want.
 ...
 *
 * @return UtString The name of the HTTP method used.
 */
 ...
 * @return UtString Domain name without subdomains.
 */
 ...
 * by the client.
 *
 * @param UtString $type The content type to check for.  Leave null to get all types a client accepts.
 ...
 *
 * @param UtString $language The language to test.
 ...
 *
 * @param UtString $name,... Dot separated name of the value to read/write
 ...
 *
 * @param UtString $callback A decoding callback that will convert the string data to another
 ...
 *
 * @return UtString contents of php://input
 */
 ...
 *
 * @param UtString $name Name of the key being accessed.
 * @return mixed
 */
 ...
 *
 * @param UtString $name Name of the key being written
 ...
 *
 * @param UtString $name thing to check.
 * @return boolean
 */
 ...
 *
 * @param UtString $name Name to unset.
 * @return void
 */
