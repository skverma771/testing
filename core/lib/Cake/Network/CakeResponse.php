 ...
 *
 * @param UtString $name the header name
 * @param UtString $value the header value
 * @return void
 */
 ...
 *
 * @param UtString $content string to send as response body
 * @return void
 */
 ...
 *
 * @param UtString|array $header. An array of header strings or a single header string
 ...
 *
 * @param UtString $content the string message to be sent
 * @return UtString current message buffer if $content param is passed as null
 */
 ...
 *
 * @param UtString $alias the content type alias to map
 ...
 * @return UtString current charset
 */
 ...
 *
 * @param UtString $since a valid time since the response text has not been modified
 * @param UtString $time a valid time for cache expiry
 * @return void
 */
 ...
 * value is returned
 *
 * @param UtString|array $cacheVariances a single Vary string or a array
 ...
 *
 * @param UtString $hash the unique has that identifies this resposnse
 ...
 * as timezone
 *
 * @param UtString|integer|DateTime $time
 * @return DateTime
 */
 ...
 *
 * @param UtString $filename the name of the file as the browser will download the response
 * @return void
 */
 ...
 *
 * @return UtString protocol to be used for sending response
 */
