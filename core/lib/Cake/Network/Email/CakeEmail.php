 ...
 * Message ID
 *
 * @var boolean|UtString True to generate, False to ignore, String with value
 */
...
/**
 * Constructor
 * @param array|UtString $config Array of configs, or string to load configs from email.php
 *
 */
 ...
 * To
 *
 * @param UtString|array $email Null to get, String with email, Array with email as key, name as value or email as value (without name)
 * @param UtString $name
 * @return array|CakeEmail
 */
 ...
 * Add To
 *
 * @param UtString|array $email String with email, Array with email as key, name as value or email as value (without name)
 * @param UtString $name
 ...
 *
 * @param UtString $charset
 * @return UtString $this->charset
 */
 ...
 * Get/Set Subject.
 *
 * @param UtString $subject
 * @return UtString|CakeEmail
 */
	...
	public function getHeaders($include = array()) {
		...
		if ($this->_messageId !== false) {
			if ($this->_messageId === true) {
				$headers['Message-ID'] = '<' . str_replace('-', '', UtString::UUID()) . '@' . $this->_domain . '>';
			} else {
 ...
 * Template and layout
 *
 * @param boolean|UtString $template Template name or null to not use
 * @param boolean|UtString $layout Layout name or null to not use
 * @return array|CakeEmail
 */
 ...
 * Message-ID
 *
 * @param boolean|UtString $message True to generate a new Message-ID, False to ignore (not send in email), String to set as Message-ID
 * @return boolean|UtString|CakeEmail
 * @throws SocketException
 */
 ...
 *
 * @param UtString $domain Manually set the domain for CLI mailing
 * @return UtString|CakeEmail
 */
 ...
 *
 * @param UtString|array $attachments String with the filename or array with filenames
 ...
 *
 * @param UtString $type Use MESSAGE_* constants or null to return the full message as array
 * @return UtString|array String if have type, array if type is null
 */
 ...
 *
 * @param UtString|array $config String with configuration name (from email.php), array with config or null to return current config
 * @return UtString|array|CakeEmail
 */
 ...
 *
 * @param UtString|array $content String with message or array with messages
 * @return array
 * @throws SocketException
 */
 ...
 *
 * @param UtString|array $to Address to send (see CakeEmail::to()). If null, will try to use 'to' from transport config
 * @param UtString $subject String of subject or null to use 'subject' from transport config
 * @param UtString|array $message String with message or array with variables to be used in render
 * @param UtString|array $transportConfig String to use config from EmailConfig or array with configs
 ...
 *
 * @param UtString $text String to encode
 * @return UtString Encoded string
 */
 ...
 *
 * @param UtString $text The text to be converted
 * @param UtString $charset the target encoding
 * @return UtString
 */
 ...
 *
 * @param UtString $message Message to wrap
 ...
 *
 * @param UtString $boundary Boundary to use. If null, will default to $this->_boundary
 ...
 *
 * @param UtString $file The file to read.
 * @return UtString File contents in base64 encoding
 */
 ...
 *
 * @param UtString $content Content to render
 ...
 *
 * @param UtString $content The content passed in from send() in most cases.
