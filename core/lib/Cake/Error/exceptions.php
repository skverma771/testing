 ...
 * Constructor
 *
 * @param UtString $message If no message is given 'Bad Request' will be the message
 * @param UtString $code Status code, defaults to 400
 */
 ...
 * Constructor
 *
 * @param UtString $message If no message is given 'Unauthorized' will be the message
 * @param UtString $code Status code, defaults to 401
 */
 ...
 * Constructor
 *
 * @param UtString $message If no message is given 'Forbidden' will be the message
 * @param UtString $code Status code, defaults to 403
 */
 ...
 * Constructor
 *
 * @param UtString $message If no message is given 'Not Found' will be the message
 * @param UtString $code Status code, defaults to 404
 */
 ...
 * Constructor
 *
 * @param UtString $message If no message is given 'Method Not Allowed' will be the message
 * @param UtString $code Status code, defaults to 405
 */
 ...
 * Constructor
 *
 * @param UtString $message If no message is given 'Internal Server Error' will be the message
 * @param UtString $code Status code, defaults to 500
 */
 ...
 * when debug = 0.
 *
 * @param UtString|array $message Either the string of the error message, or an array of attributes
 *   that are made available in the view, and sprintf()'d into CakeException::$_messageTemplate
 * @param UtString $code The code of the error, is also the HTTP status code for the error.
 */
