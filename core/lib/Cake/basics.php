 ...
 * @param UtString $sortby Sort by this key
 * @param UtString $order  Sort order asc/desc (ascending or descending).
 ...
 *
 * @param UtString|array|CakeObject $text Text to wrap through htmlspecialchars.  Also works with arrays, and objects.
 *    Arrays will be mapped and have all their elements escaped.  Objects will be string cast if they
 *    implement a `__toString` method.  Otherwise the class name will be used.
 * @param boolean $double Encode existing html entities
 * @param UtString $charset Character set to use when escaping.  Defaults to config value in 'App.encoding' or 'UTF-8'
 * @return UtString Wrapped text
 ...
 * @param UtString $plugin Optional default plugin to use if no plugin is found. Defaults to null.
 ...
 *
 * @param  UtString $key Environment variable name.
 * @return UtString Environment variable setting.
 ...
 *
 * @param  UtString $path	File path within /tmp to save the file.
 * @param  mixed  $data	The data to save to the temporary file.
 * @param  mixed  $expires A valid strtotime string when the data expires.
 * @param  UtString $target  The target of the cached data; either 'cache' or 'public'.
 ...
 *
 * @param UtString|array $params As String name to be searched for deletion, if name is a directory all files in
 *   directory will be deleted. If array, names to be searched for deletion. If clearCache() without params,
 *   all files in app/tmp/cache/views will be deleted
 * @param UtString $type Directory in tmp/cache defaults to view directory
 * @param UtString $ext The file extension you are deleting
 ...
 *
 * @param UtString $singular Text to translate
 ...
 *
 * @param UtString $singular Singular text to translate
 * @param UtString $plural Plural text
 ...
 *
 * @param UtString $domain Domain
 * @param UtString $msg String to translate
 * @param mixed $args Array with arguments or multiple arguments in function
 ...
 *
 * @param UtString $domain Domain
 * @param UtString $singular Singular string to translate
 * @param UtString $plural Plural
 * @param integer $count Count
 * @param mixed $args Array with arguments or multiple arguments in function
 ...
 *
 * @param UtString $domain Domain
 * @param UtString $msg Message to translate
 ...
 *
 * @param UtString $message Message to write to log
 * @return void
 ...
 *
 * @param UtString $file File to look for
 ...
 *
 * @param UtString String to convert
 * @return UtString with underscore remove from start and end of string
 ...
 */
	...
	//    var_dump($attachment);
		...
		//dd($attachment);
		//trigger_error("IDDD".print_r($attachment, true), E_USER_WARNING);
