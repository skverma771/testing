 ...
 *
 * @param UtString $routeClass to set as default
 ...
 *
 * @param UtString $route A string describing the template of the route
 ...
 *
 * @param UtString|array $controller A controller name or array of controller names (i.e. "Posts" or "ListItems")
 ...
 *
 * @param UtString $url URL to be parsed
 ...
 *
 * @param UtString|array $url Cake-relative URL, like "/products/edit/92" or "/presidents/elect/4"
 ...
 * @return UtString A generated url for the array
 * @see Router::url()
 */
 ...
 *
 * @param UtString|array $q Query string Either a string of already compiled query string arguments or
 ...
 *     the url.
 * @return UtString The string that is the reversed result of the array
 */
 ...
 * of the input value.
 *
 * @param array|UtString $url URL to normalize Either an array or a string url.
 * @return UtString Normalized URL
 */
 ...
 *
 * @param UtString $base Base URL
 * @param UtString $plugin Plugin name
 * @return UtString base url with plugin name removed if present
 */
