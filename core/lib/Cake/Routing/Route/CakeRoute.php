 ...
 *
 * @param UtString $template Template string with parameter placeholders
 ...
 *
 * @param UtString $url The url to attempt to parse.
 ...
 *
 * @param UtString $args A string with the passed & named params.  eg. /1/page:2
 * @param UtString $context The current route context, which should contain controller/action keys.
 ...
 *
 * @param UtString $val The value of the named parameter
 * @param array $rule The rule(s) to apply, can also be a match string
 * @param UtString $context An array with additional context information (controller / action)
 * @return boolean
 */
 ...
 * @return UtString Composed route string.
 */
