 ...
 *
 * @param UtString $script The JavaScript to be wrapped in SCRIPT tags.
 * @param array $options Set of options:
 * @return UtString The full SCRIPT element, with the JavaScript inside it, or null,
 ...
 *
 * @param UtString $script string that might have javascript elements
 ...
 *	+ "'" => "\\'"
 *
 * @param  UtString $script String that needs to get escaped.
 * @return UtString Escaped string.
 */
 ...
 *
 * @param UtString $object Object to be observed
 * @param UtString $event event to observe
 * @param UtString $observer function to call
 ...
 * public/javascripts/ directory, and use @param UtString $script Script file to include
 * @param array $options Set options for codeBlock
 * @return UtString script with all javascript in/javascripts folder
 ...
 * @param UtString $prefix DEPRECATED, use $options['prefix'] instead. Prepends the string to the returned data
 * @param UtString $postfix DEPRECATED, use $options['postfix'] instead. Appends the string to the returned data
 ...
 * @param UtString $q DEPRECATED, use $options['q'] instead. The type of quote to use
