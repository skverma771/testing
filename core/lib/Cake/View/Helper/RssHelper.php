 ...
 * @param UtString $content
 * @return UtString An RSS document
 ...
 * @param UtString $content Content (`<item />`'s belonging to this channel
 * @return UtString An RSS `<channel />`
 ...
 * @param UtString|array $callback A string function name, or array containing an object
 *     and a string method name
 * @return UtString A set of RSS `<item />` elements
 ...
 * @return UtString An RSS `<item />` element
 ...
 *
 * @param integer|UtString|DateTime $time
 * @return UtString An RSS-formatted timestamp
 ...
 *
 * @param UtString $name The name of the XML element
 * @param array $attrib The attributes of the XML element
 * @param UtString|array $content XML element content
