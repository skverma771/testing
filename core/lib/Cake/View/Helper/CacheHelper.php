 ...
 *
 * @param UtString $file The filename to process.
 * @param UtString $out The output for the file.
 * @return UtString Updated content.
 */
 ...
 *
 * @param UtString $file File to cache
 * @param UtString $out output to cache
 * @return UtString view ouput
 * @link http://book.cakephp.org/2.0/en/core-libraries/helpers/cache.html
 */
 ...
 *
 * @param UtString $file The filename that needs to be parsed.
 * @param UtString $cache The cached content
 * @return void
 */
 ...
 *
 * @return UtString The content with cake:nocache tags replaced.
 */
 ...
 *
 * @param UtString $content String to remove tags from.
 * @return UtString String with tags removed.
 */
 ...
 *
 * @param UtString $cache Output to replace content in.
 * @return UtString with all replacements made to <!--nocache--><!--nocache-->
 */
 ...
 *
 * @param UtString $content view content to write to a cache file.
 * @param UtString $timestamp Duration to set for cache file.
