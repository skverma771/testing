 ...
 *
 * @param UtString $method Method to be called
 ...
 *
 * @param UtString $script Script string to add to the buffer.
 ...
 *
 * @return UtString Generated JSON object of all set vars
 */
 ...
 * @param UtString|array $url Mixed either a string URL or an cake url array.
 * @param array $options Options for both the HTML element and Js::request()
 * @return UtString Completed link. If buffering is disabled a script tag will be returned as well.
 ...
 *
 * @param UtString|array $one Either an array of variables to set, or the name of the variable to set.
 * @param UtString|array $two If $one is a string, $two is the value for that key.
 * @return void
 ...
 *
 * @param UtString $caption The display text of the submit button.
 * @param array $options Array of options to use. See the options for the above mentioned methods.
 * @return UtString Completed submit button.
