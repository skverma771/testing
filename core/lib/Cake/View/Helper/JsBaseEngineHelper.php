 ...
 *
 * @param UtString $message Message you want to alter.
 * @return UtString completed alert()
 */
 ...
 *
 * @param UtString|array $url
 * @param array  $options
 * @return UtString completed redirect in javascript
 */
 ...
 *
 * @param UtString $message Message you want confirmed.
 * @return UtString completed confirm()
 */
 ...
 * function scope.
 *
 * @param UtString $message Message to use in the confirm dialog.
 * @return UtString completed confirm with return script
 */
 ...
 *
 * @param UtString $message Message you want to prompt.
 * @param UtString $default Default message
 * @return UtString completed prompt()
 */
 ...
 * @return UtString A JSON code block
 */
 ...
 * @return UtString a JavaScript-safe/JSON representation of $val
 */
 ...
 * - '"' => '\"'
 *
 * @param UtString $string String that needs to get escaped.
 * @return UtString Escaped string.
 */
 ...
 *
 * @param UtString $string The string that needs to be utf8->hex encoded
 * @return void
 */
 ...
 *
 * @param UtString $selector The selector that is targeted
 ...
 *
 * @param UtString $type Type of event to bind to the current dom id
 * @param UtString $callback The Javascript function you wish to trigger or the function literal
 * @param array $options Options for the event.
 * @return UtString completed event handler
 */
 ...
 *
 * @param UtString $functionBody The code to run on domReady
 * @return UtString completed domReady method
 */
 ...
 *
 * @param UtString $callback The function body you wish to apply during the iteration.
 * @return UtString completed iteration
 */
 ...
 *   the speed option.
 *
 * @param UtString $name The name of the effect to trigger.
 * @param array $options Array of options for the effect.
 * @return UtString completed string with effect.
 */
 ...
 *
 * @param UtString|array $url Array or String URL to target with the request.
 * @param array $options Array of options. See above for cross library supported options
 * @return UtString XHR request.
 */
 ...
 * @return UtString Completed drag script
 */
 ...
 * @return UtString Completed drop script
 */
 ...
 * @return UtString Completed sortable script.
 */
 ...
 * @return UtString Completed slider script
 */
 ...
 * @return UtString completed form serialization script
 */
 ...
 * @return UtString Parsed JSON options without enclosing { }.
 */
 ...
 *
 * @param UtString $method Name of method whose options are being worked with.
 ...
 * _callbackArgs array.
 *
 * @param UtString $method Name of the method you are preparing callbacks for.
 ...
 *
 * @param UtString $method Name of method processing options for.
 * @param array $options Array of options to process.
 * @return UtString Parsed options string.
 */
 ...
 * @return UtString Querystring fragment
 */
