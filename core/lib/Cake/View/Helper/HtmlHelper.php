 ...
 *
 * @param UtString $name Text for link
 * @param UtString $link URL for link (if empty it won't be a link)
 * @param UtString|array $options Link attributes e.g. array('id' => 'selected')
 * @return void
 ...
 *  - xhtml11: XHTML1.1.
 *
 * @param UtString $type Doctype to use.
 * @return UtString Doctype string
 ...
 *
 * @param UtString $type The title of the external resource
 * @param UtString|array $url The address of the external resource or string for content attribute
 * @param array $options Other attributes for the generated tag. If the type attribute is html,
 *    rss, atom, or icon, the mime-type is returned.
 * @return UtString A completed `<link />` element.
 ...
 *
 * @param UtString $charset The character set to be used in the meta tag. If empty,
 *  The App.encoding value will be used. Example: "utf-8".
 * @return UtString A meta tag containing the specified character set.
 ...
 *
 * @param UtString $title The content to be wrapped by <a> tags.
 * @param UtString|array $url Cake-relative URL or array of URL parameters, or external URL (starts with http://)
 * @param array $options Array of HTML attributes.
 * @param UtString $confirmMessage JavaScript confirmation message.
 * @return UtString An `<a />` element.
 ...
 *
 * @param UtString|array $path The name of a CSS style sheet or an array containing names of
 *   CSS stylesheets. If `$path` is prefixed with '/', the path will be relative to the webroot
 *   of your application. Otherwise, the path will be relative to your CSS path, usually webroot/css.
 * @param UtString $rel Rel attribute. Defaults to "stylesheet". If equal to 'import' the stylesheet will be imported.
 * @param array $options Array of HTML attributes.
 * @return UtString CSS <link /> or <style /> tag, depending on the type of link.
 ...
 * - `plugin` False value will prevent parsing path as a plugin
 *
 * @param UtString|array $url String or array of javascript files to include
 ...
 *   Defaults to `script`.
 *
 * @param UtString $script The script to wrap
 ...
 * @return UtString CSS styling data
 ...
 *
 * @param UtString $separator Text to separate crumbs.
 * @param UtString|array|boolean $startText This will be the first crumb, if false it defaults to first crumb in array. Can
 *   also be an array, see above for details.
 * @return UtString Composed bread crumbs
 * @link http://book.cakephp.org/2.0/en/core-libraries/helpers/html.html#creating-breadcrumb-trails-with-htmlhelper
 */
 ...
 * @return UtString breadcrumbs html list
 * @link http://book.cakephp.org/2.0/en/core-libraries/helpers/html.html#creating-breadcrumb-trails-with-htmlhelper
 */
 ...
 * - `plugin` False value will prevent parsing path as a plugin
 *
 * @param UtString $path Path to the image file, relative to the app/webroot/img/ directory.
 * @param array $options Array of HTML attributes.  See above for special options.
 * @return UtString completed img tag
 ...
 * @return UtString Completed table headers
 ...
 * @return UtString Formatted HTML
 ...
 *
 * @param UtString $name Tag name.
 * @param UtString $text String content that will appear inside the div element.
 *   If null, only a start tag will be printed
 * @param array $options Additional HTML attributes of the DIV tag, see above.
 * @return UtString The formatted tag element
 ...
 *
 * @param UtString $tag Tag name
 * @return UtString Formatted block
 ...
 * - `escape` Whether or not the contents should be html_entity escaped.
 *
 * @param UtString $class CSS class name of the div element.
 * @param UtString $text String content that will appear inside the div element.
 *   If null, only a start tag will be printed
 * @param array $options Additional HTML attributes of the DIV tag
 * @return UtString The formatted DIV element
 ...
 * - `escape` Whether or not the contents should be html_entity escaped.
 *
 * @param UtString $class CSS class name of the p element.
 * @param UtString $text String content that will appear inside the p element.
 * @param array $options Additional HTML attributes of the P tag
 * @return UtString The formatted P element
 ...
 *
 * @param UtString|array $path Path to the video file, relative to the webroot/{$options['pathPrefix']} directory.
 *  Or an array where each item itself can be a path string or an associate array containing keys `src` and `type`
 * @param array $options Array of HTML attributes, and special options above.
 * @return UtString Generated media element
 */
 ...
 * @param UtString $tag Type of list tag to use (ol/ul)
 * @return UtString The nested list
 ...
 * @param array $itemOptions Additional HTML attributes of the list item (LI) tag
 * @param UtString $tag Type of list tag to use (ol/ul)
 * @return UtString The nested list element
 ...
 *
 * @param UtString|array $configFile String with the config file (load using PhpReader) or an array with file and reader name
 * @param UtString $path Path with config file
