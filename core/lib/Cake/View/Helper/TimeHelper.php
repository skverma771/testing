...
/**
 * @param integer|UtString|DateTime $dateString UNIX timestamp, strtotime() valid string or DateTime objectp
 * @param UtString|DateTimeZone $timezone User's timezone string or DateTimeZone object
...
/**
 * @param integer|UtString|DateTime $dateTime UNIX timestamp, strtotime() valid string or DateTime object
...
/**
 * @param integer|UtString|DateTime $string UNIX timestamp, strtotime() valid string or DateTime object
 * @return integer UNIX timestamp
 * @see CakeTime::gmt()
 *
 * @link http://book.cakephp.org/2.0/en/core-libraries/helpers/time.html#formatting
...
/**
 * @param integer|UtString|DateTime $format date format string (or a UNIX timestamp, strtotime() valid string or DateTime object)
