 ...
 */
	public function __construct(View $View, $settings = array()) {
		$settings = Hash::merge(array('engine' => 'UtString'), $settings);
 ...
 * @return UtString The text with links
 ...
 * @return UtString Replaced values.
 */
 ...
 *
 * @param UtString $text The text to operate on.
 * @param array $htmlOptions The options for the generated links.
 * @return UtString The text with links inserted.
 */
