 ...
 *
 * @param UtString $model Optional model name.  Uses the default if none is specified.
 ...
 *
 * @param array|UtString $options Default options for pagination links. If a string is supplied - it
 ...
 *
 * @param UtString $model Optional model name.  Uses the default if none is specified.
 * @return UtString The current page number of the recordset.
 ...
 * @return UtString The name of the key by which the recordset is being sorted, or
 ...
 * @param UtString $model Optional model name.  Uses the default if none is specified.
 * @param array $options Options for pagination links. See #options for list of keys.
 * @return UtString The direction by which the recordset is being sorted, or
 *  null if the results are not currently sorted.
 ...
 *
 * @param UtString $title Title for the link. Defaults to '<< Previous'.
 * @param array $options Options for pagination link. See #options for list of keys.
 * @param UtString $disabledTitle Title when the link is disabled.
 * @param array $disabledOptions Options for the disabled pagination link. See #options for list of keys.
 * @return UtString A "previous" link or $disabledTitle text if the link is disabled.
 ...
 * - `model` The model to use, defaults to PaginatorHelper::defaultModel()
 *
 * @param UtString $title Title for the link. Defaults to 'Next >>'.
 ...
 * @return UtString A "next" link or or $disabledTitle text if the link is disabled.
 ...
 *
 * @param UtString $key The name of the key that the recordset should be sorted.
 * @param UtString $title Title for the link. If $title is null $key will be used
 *		for the title and will be generated by inflection.
 * @param array $options Options for sorting link. See above for list of keys.
 * @return UtString A link sorting default by 'asc'. If the resultset is sorted 'asc' by the specified
 ...
 * - `model` The model to use, defaults to PaginatorHelper::defaultModel()
 *
 * @param UtString $title Title for the link.
 * @param UtString|array $url Url for the action. See Router::url()
 * @param array $options Options for the link. See #options for list of keys.
 * @return UtString A link with pagination parameters.
 ...
 * @param UtString $model Which model to paginate on
 ...
 *
 * @param UtString $which
 * @param UtString $title
 * @param array $options
 * @param UtString $disabledTitle
 ...
 *
 * @param UtString $model Model name to get parameters for.
 ...
 *
 * @return UtString Model name or null if the pagination isn't initialized.
 ...
 * @return UtString Counter string.
 ...
 * @return UtString numbers string.
 ...
 *
 * @param UtString|integer $first if string use as label for the link. If numeric, the number of page links
 ...
 * - `ellipsis` Content for ellipsis, defaults to '...'
 *
 * @param UtString|integer $last if string use as label for the link, if numeric print page numbers
