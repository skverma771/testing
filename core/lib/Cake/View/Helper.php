 ...
 *
 * @param UtString $method Method to invoke
 ...
 *
 * @param UtString $name Name of the property being accessed.
 ...
 *
 * @param UtString|array $url Either a relative string url like `/products/view/23` or
 *    an array of url parameters.  Using an array for urls will allow you to leverage
 *    the reverse routing features of CakePHP.
 * @param boolean $full If true, the full base URL will be prepended to the result
 * @return UtString  Full translated URL with base path.
 ...
 *
 * @param UtString $file The file to create a webroot path to.
 * @return UtString Web accessible path to file.
 */
 ...
 *
 * @param UtString|array Path string or url array
 * @param array $options Options array. Possible keys:
 *   `fullBase` Return full url with domain name
 *   `pathPrefix` Path prefix for relative urls
 *   `ext` Asset extension to append
 *   `plugin` False value will prevent parsing path as a plugin
 * @return UtString Generated url
 */
 ...
 *
 * @param UtString $path The file path to timestamp, the path must be inside WWW_ROOT
 * @return UtString Path with a timestamp added, or not.
 */
 ...
 *
 * @param UtString|array $output Either an array of strings to clean or a single string to clean.
 * @return UtString|array cleaned content for output
 */
 ...
 * @param UtString $insertBefore String to be inserted before options.
 * @param UtString $insertAfter String to be inserted after options.
 * @return UtString Composed attributes.
 ...
 *
 * @param UtString $key The name of the attribute to create
 * @param UtString $value The value of the attribute to create.
 * @param boolean $escape Define if the value must be escaped
 * @return UtString The composed attribute.
 * @deprecated This method will be moved to HtmlHelper in 3.0
 */
 ...
 *
 * @param UtString $entity A field name, like "ModelName.fieldName" or "ModelName.ID.fieldName"
 ...
 *
 * @param array|UtString $options Either an array of html attributes to add $id into, or a string
 *   with a view entity path to get a domId for.
 * @param UtString $id The name of the 'id' attribute.
 ...
 *
 * @param array|UtString $options If an array, should be an array of attributes that $key needs to be added to.
 *   If a string or null, will be used as the View entity.
 * @param UtString $field
 * @param UtString $key The name of the attribute to be set, defaults to 'name'
 ...
 *   If a string or null, will be used as the View entity.
 * @param UtString $field
 * @param UtString $key The name of the attribute to be set, defaults to 'value'
 * @return mixed If an array was given for $options, an array with $key set will be returned.
 *   If a string was supplied a string will be returned.
 * @todo Refactor this method to not have as many input/output options.
 */
 ...
 *
 * @param UtString $field The field name to initialize.
 ...
 * @param UtString $class The classname being added.
 * @param UtString $key the key to use for class.
 ...
 *
 * @param UtString $str String to be output.
 * @return UtString
 ...
 *
 * @param UtString $viewFile The view file that is going to be rendered
 * @return void
 */
 ...
 * Overridden in subclasses.
 *
 * @param UtString $viewFile The view file that was rendered.
 * @return void
 */
 ...
 * Overridden in subclasses.
 *
 * @param UtString $layoutFile The layout about to be rendered.
 * @return void
 */
 ...
 * Overridden in subclasses.
 *
 * @param UtString $layoutFile The layout file that was rendered.
 * @return void
 */
 ...
 * Overridden in subclasses.
 *
 * @param UtString $viewFile The file about to be rendered.
 * @return void
 */
 ...
 * Overridden in subclasses.
 *
 * @param UtString $viewFile The file just be rendered.
 * @param UtString $content The content that was rendered.
 * @return void
 */
