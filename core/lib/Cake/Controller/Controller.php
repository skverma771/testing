 ...
 *
 * @param UtString $modelClass Name of model class to load
 * @param integer|UtString $id Initial ID the instanced model class should have
 ...
 *
 * @param UtString|array $url A string or array-based URL pointing to another location within the app,
 *     or an absolute URL
 ...
 * @param UtString|array $url The same value of beforeRedirect
 ...
 *
 * @param UtString $status The header message that is being set.
 * @return void
 ...
 * }}}
 *
 * @param UtString $action The new action to be 'redirected' to
 ...
 *
 * @param UtString $view View to use for rendering
 ...
 *
 * @param UtString $default Default URL to use if HTTP_REFERER cannot be read from headers
 * @param boolean $local If true, restrict referring URLs to local server
 * @return UtString Referring URL
 ...
 *
 * @param UtString $message Message to display to the user
 * @param UtString|array $url Relative string or array-based URL to redirect to after the time expires
 * @param integer $pause Time to show the message
 * @param UtString $layout Layout you want to use, defaults to 'flash'
 ...
 * @param UtString|array $op A string containing an SQL comparison operator, or an array matching operators
 *        to fields
 * @param UtString $bool SQL boolean operator: AND, OR, XOR, etc.
 ...
 *
 * @param Model|UtString $object Model to paginate (e.g: model instance, or 'Model', or 'Model.InnerModel')
 * @param UtString|array $scope Conditions to use while paginating
 ...
 *
 * @param UtString $method name of method called example index, edit, etc.
 ...
 * This method should be overridden in child classes.
 *
 * @param UtString $method name of method called either edit or update.
 * @return boolean Success
 * @link http://book.cakephp.org/2.0/en/controllers.html#callbacks
 */
