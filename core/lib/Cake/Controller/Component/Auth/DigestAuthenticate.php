 ...
 *
 * @param UtString $username The username/identifier.
 * @param UtString $password Unused password, digest doesn't require passwords.
 ...
 *
 * @param UtString $digest The raw digest authentication headers.
 ...
 * @param UtString $password The digest hash password generated with DigestAuthenticate::password()
 * @return UtString Response hash
 */
 ...
 *
 * @param UtString $username The username to use in the digest hash.
 * @param UtString $password The unhashed password to make a digest hash for.
 * @param UtString $realm The realm the password is for.
 * @return UtString the hashed password that can later be used with Digest authentication.
 */
 ...
 *
 * @return UtString Headers for logging in.
 */
