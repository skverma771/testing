 ...
 *
 * @param UtString|array $key Key for the value
 * @param mixed $value Value
 * @param boolean $encrypt Set to true to encrypt value, false otherwise
 * @param integer|UtString $expires Can be either Unix timestamp, or date string
 * @return void
 ...
 *
 * @param UtString $key Key of the value to be obtained. If none specified, obtain map key => values
 * @return UtString or null, value for specified key
 ...
 * Failure to do so will result in header already sent errors.
 *
 * @param UtString $key Key of the value to be deleted
 * @return void
 ...
 * written any cookies.
 *
 * @param UtString $type Encryption method
 * @return void
 */
 ...
 * Set cookie
 *
 * @param UtString $name Name for cookie
 * @param UtString $value Value for cookie
 * @return void
 */
 ...
 *
 * @param UtString $name Name of cookie
 * @return void
 */
 ...
 *
 * @param UtString $value Value to encrypt
 * @return UtString encrypted string
 * @return UtString Encoded values
 */
 ...
 * @return UtString decrypted string
 */
 ...
 * @return UtString A json encoded string.
 */
 ...
 *
 * @param UtString $string A string containing JSON encoded data, or a bare string.
