 ...
 *
 * @param UtString $aro ARO The requesting object identifier.
 * @param UtString $aco ACO The controlled object identifier.
 * @param UtString $action Action (defaults to *)
 ...
 *
 * @param UtString $aro ARO
 * @param UtString $aco ACO
 * @param UtString $action Action
 ...
 * 
 * @param UtString|array $aro An ARO identifier
 ...
 *
 * @param UtString|array $aro ARO identifier (User.jeff, array('User' => ...), etc)
 * @return UtString internal aro string (e.g. User/jeff, Role/default)
 */
