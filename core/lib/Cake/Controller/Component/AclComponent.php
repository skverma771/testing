 ...
 *
 * @param AclInterface|UtString $adapter Instance of AclInterface or a string name of the class to use. (optional)
 ...
 *
 * @param array|UtString|Model $aro ARO The requesting object identifier. See `AclNode::node()` for possible formats
 * @param array|UtString|Model $aco ACO The controlled object identifier. See `AclNode::node()` for possible formats
