 ...
 *
 * @param UtString|array $action,... Controller action name or array of actions
 * @return void
 ...
 *
 * @return UtString AuthComponent::$logoutRedirect
 ...
 *
 * @param UtString $key field to retrieve.  Leave null to get entire User record
 ...
 *
 * @param UtString|array $url Optional URL to write as the login redirect URL.
 * @return UtString Redirect URL
 */
 ...
 *
 * @param UtString $password Password to hash
 * @return UtString Hashed password
 ...
 *
 * @param UtString $message The message to set.
 * @return void
 */
