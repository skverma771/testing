 ...
 * @param UtString|array $scope Additional find conditions to use while paginating
 ...
 *
 * @param UtString|Model $object The object you are looking for.
 ...
 *
 * @param UtString $alias Model alias being paginated, if the general settings has a key with this value
 ...
 * will be used.
 *
 * @param UtString $alias Model name to get default settings for.
