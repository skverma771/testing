 ...
 *
 * @param Controller $controller A reference to the controller
 * @param UtString|array $url A string or array containing the redirect location
 ...
 *
 * @return UtString Prototype version of component making Ajax call
 */
 ...
 * startup method.
 *
 * @param UtString $name The name of the Content-type, i.e. "html", "xml", "css"
 * @param UtString|array $type The Content-type or array of Content-types assigned to the name,
 ...
 *
 * @return UtString Server address
 ...
 *
 * @param boolean $safe
 * @return UtString Client IP address
 ...
 *
 * @param UtString|array $type Can be null (or no parameter), a string type name, or an
 *   array of types
 ...
 *
 * @param UtString|array $type Can be null (or no parameter), a string type name, or an array of types
 ...
 * HTTP_ACCEPT.
 *
 * @param UtString|array $type An optional array of 'friendly' content-type names, i.e.
 *   'html', 'xml', 'js', etc.
 ...
 * @param UtString $type Type of response to send (e.g: 'ajax')
 ...
 *
 * @param UtString|array $type Friendly type name, i.e. 'html' or 'xml', or a full content-type,
 ...
 *
 * @param UtString|array $cType Either a string content type to map, or an array of types.
 * @return UtString|array Aliases for the types provided.
 ...
 *
 * @param UtString|array $alias String alias to convert back into a content type. Or an array of aliases to map.
 * @return UtString Null on an undefined alias.  String value of the mapped alias type.  If an
 ...
 *
 * @param UtString $type The type alias being converted, ie. json
