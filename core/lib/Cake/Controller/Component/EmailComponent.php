 ...
 *
 * @param UtString|array $content Either an array of text lines, or a string with contents
 *  If you are rendering a template this variable will be sent to the templates as `$content`
 * @param UtString $template Template to use when sending email
 * @param UtString $layout Layout to use to enclose email body
 ...
 *
 * @param UtString $attachment Attachment file name to find
 * @return UtString Path to located file
 */
 ...
 *
 * @param UtString $value Value to strip
 * @param boolean $message Set to true to indicate main message content
 * @return UtString Stripped value
 */
