 ...
 *
 * @param UtString $userAgent Set the userAgent
 * @return void
 */
 ...
 *
 * @param UtString $name The name of the key your are setting in the session.
 * 							This should be in a Controller.key format for better organizing
 * @param UtString $value The value you want to store in a session.
 ...
 *
 * @param UtString $name the name of the session key you want to read
 ...
 *
 * @param UtString $name the name of the session key you want to delete
 ...
 *
 * @param UtString $name the name of the session key you want to check
 ...
 *
 * @return UtString Last session error
 */
 ...
 *
 * @param UtString $message Message to be flashed
 * @param UtString $element Element to wrap flash message in.
 * @param array $params Parameters to be sent to layout as view variables
 * @param UtString $key Message key, default is 'flash'
 * @return void
 ...
 *
 * @param UtString $id Id to use (optional)
 * @return UtString The current session id.
 */
