...
$config['debug'] = DEBUG;
$config['site']['license_key'] = '25249-11415-177-1455885843-bbcbff5c';
...
if (method_exists('CmsHook', 'setExceptionUrl')) {
    CmsHook::setExceptionUrl(array(
		...
		'pledge_project_categories/index',
		'staticpages/view',
		'success_stories/index',
		'home_videos/index',
		'home_videos/homepage_pdf_download',
		'montages/index',
		'montages/view',
        'pledge_project_categories/listall',
        'payments/success_payment',
        'payments/cancel_payment',
        'payments/process_ipn',

    ));
}
$config['site']['is_admin_settings_enabled'] = true;
if (!empty($_SERVER['HTTP_HOST']) && in_array($_SERVER['HTTP_HOST'], array('crowdfunding.dev.agriya.com', 'crowdfundingpb.dev.agriya.com', 'crowdfundingpl.dev.agriya.com')) && !in_array($_SERVER['REMOTE_ADDR'], array('182.72.136.170'))) {
