...
class AppController extends Controller
{
    ...
    public function __construct($request = null, $response = null)
    {
        ...
        /*if (!defined('STDIN') && $_SERVER['HTTP_HOST'] != 'localhost' && strstr($_SERVER['HTTP_HOST'], '.dev1.agriya.com') != '.dev1.agriya.com' && strstr($_SERVER['HTTP_HOST'], '.dev.agriya.com') != '.dev.agriya.com' && strstr($_SERVER['HTTP_HOST'], '.cssilize.com') != '.cssilize.com') {
    ...
    public function beforeFilter()
    {
	    ...
	    parent::beforeFilter();
	    //te(123);
	    //pd($this->Auth->user('id'), true);
	   // pd('beforeFilter_called', true);
        //$this->request->addParam( Router::parse($this->request->url));
