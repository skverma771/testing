...
class PaymentsController extends AppController
{
	...
	{
		$this->autoRender = false;
		$this->log('Process_payment_working','cancel_log');
    ...
    {
		$this->log('Process_payment_working-3','success_log');
        switch ($transaction_type) {
			case ConstProjectFundStatus::Backed:
			$this->log('Process_payment_working-4','success_log');
		...
		$this->log('Process_payment_working-5','success_log');
        return $redirect;
    }
    ...
    {
		$this->autoRender = false;
		$this->log('Process_payment_working','ipn_log');
