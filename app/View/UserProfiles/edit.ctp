    ...
    <fieldset>
          <legend><?php echo __l('Personal Info');?></legend>
		   <div class="span3 pull-right top-mspace">
				<img src="https://chart.googleapis.com/chart?cht=qr&chl=<?php echo Router::url( $this->here, true ); ?>&chs=83x83&chld=L|0" alt="QR Code" >
		   </div>
          <div class="span3 pull-right top-mspace">
           ...
           <div class="span16 top-mspace pull-left">
          <?php
    ...
    <fieldset>
      ...
      <fieldset>
        ...
        <?php   echo $response->data['content'];?>
                ...
                <?php endif;?>
    <fieldset>
    <legend><?php echo __l('Paypal Information');?></legend>
    
    <div class="pull-left pr auto-comp top-mspace">
    <p><span class="error-message"><?php echo __l('If you are a project owner,provide valid information for the pledge amount revceived to your paypal account ');?></span></p>
    <?php echo $this->Form->input('paypal_first_name', array('label'=>__l('Paypal account\'s First Name')));
               echo $this->Form->input('paypal_last_name' , array('label'=>__l('Paypal account\'s Last Name')));
               echo $this->Form->input('paypal_account', array('label'=>__l('Paypal account')));
            ?>
    </div>
    </fieldset>
    <fieldset>
