 <h2 class="ver-space"><?php echo __l('Register'); ?></h2>
 <article class="thumbnail users-login clearfix">
...
<?php } ?>
  ...
  <h4 class="dc"><?php echo __l('Quick Sign Up');?></h4>
  </div>
