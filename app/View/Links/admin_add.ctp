<div class="links form space">
  ...
  <ul class="nav nav-tabs">
    ...
    <li>
      <?php echo $this->Html->link('<i class="icon-th-list blackc"></i>'.__l('Links'), array('action' => 'index', $menuId),array('class' => 'blackc', 'title' =>  __l('Links'),'data-target'=>'#list_form', 'escape' => false));?>
    </li>
    <li class="active">
