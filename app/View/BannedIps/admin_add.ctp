...
<div class="bannedIps form space">
  <ul class="breadcrumb">
    <li>
  ...
  <ul class="nav nav-tabs">
    <li>
      <?php echo $this->Html->link('<i class="icon-th-list blackc"></i>'.__l('List'), array('controller' => 'banned_ips', 'action' => 'index'),array('class' => 'blackc', 'title' =>  __l('List'),'data-target'=>'#list_form', 'escape' => false));?>
    </li>
    <li class="active">
      <a class="blackc" href="#add_form">
    ...
    <div id="add_form" class="tab-pane fade in active">
      <div class="js-corner" id="form-content">
        <?php echo $this->Form->create('BannedIp', array('class' => 'form-horizontal form-large-fields'));?>
          ...
          ?>
          <legend><h3><?php echo __l('Ban Details'); ?></h3></legend>
          <?php
          ...
          <div class="clearfix form-actions">
            ...
            <div class = "hor-mspace hor-space pull-left" >
              <?php echo $this->Html->link(__l('Cancel'), array('controller' => 'banned_ips', 'action' => 'index'), array('class' => 'btn js-tooltip', 'title' => __l('Cancel'), 'escape' => false));?>
            </div>
          </div>
