...
class LayoutHelper extends AppHelper
{
    ...
    function adminMenus($menus, $options = array()) 
    {
        ...
        $out = '<div class="navbar no-mar"><div class="navbar-inner hor-space no-round clearfix"><a data-target=".nav-collapse" data-toggle="collapse" class="btn btn-navbar ver-mspace"> <i class="icon-align-justify icon-24 blackc"></i></a><div class="nav-collapse">';
