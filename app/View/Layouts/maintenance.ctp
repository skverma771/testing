    ...
    <div id="<?php echo $this->Html->getUniquePageId();?>" class="content">
      ...
      <div class="beta-block">
        <section class="thumbnail dc space thumb-alpha">
          <h1 class="ver-mspace top-space"><?php echo $this->Html->link($this->Html->image('logo1.png'),  Router::url('/', true) ,array('title' => Configure::read('site.name'),'escape' => false, 'class'=>"brand"));?></h1>
