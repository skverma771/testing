...
<table class="table table-striped table-bordered table-condensed table-hover">
    <tr>
      ...
      <th class="dl"><div><?php echo $this->Paginator->sort('openid');?></div></th>
    </tr>
    <?php
    if (!empty($userOpenids)):
      ...
      ?>
      <tr>
        <td colspan="4" class="errorc space"><i class="icon-warning-sign errorc"></i> <?php echo sprintf(__l('No %s available'), __l('OpenIDs'));?></td>
      </tr>
      <?php
    endif;
    ?>
