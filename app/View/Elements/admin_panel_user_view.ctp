						...
						<div class="span20 tab-pane fade in active" id="admin-actions" style="display: block;">
							<ul class="unstyled clearfix">
							  ...
							  <?php endif; ?>
								...
								<li class="pull-left dc mspace">
								  <?php echo $this->Html->link('<i class="icon-lock"></i> '.__l('Change password'), array('controller' => 'users', 'action'=>'admin_change_password', $user['User']['id']), array('class' => 'btn blackc js-no-pjax', 'escape'=>false,'title' => __l('Change password')));?>
								</li>
							  <?php endif; ?>
							</ul>
						</div>
