...
<div id="footer-top">
		<div class="container footer-top clearfix space-imp">

			<div class="span7 clearfix">
				<?php echo $this->element('Pledge.pledge_project_categories-index', array('type' => 'footer'));?>				
			</div>

			<div class="span6">
				<h5 class="ver-space bot-mspace">Keep in touch</h5>
				<p>We are a social company, and like to get to know you and keep you up to date with latest features, blogs, ideas in the spotlight and many more.</p>
				<ul class="footer-follow unstyled over-hide">
					<li class="twitter"><a href="http://twitter.com/BuskerDues" title="twitter" target="_blank">Twitter</a></li>
					<li class="facebook"><a href="http://www.facebook.com/pages/sfplatform/464629930229988?ref=ts" title="Facebook" target="_blank">Facebook</a></li>
				</ul>
			</div>

			<div class="clearfix span10 total-amount-block ver-space">
				<dl class="amount-list">
					<dt>Funded Amount</dt>
						<dd class="round-3">$<span class="c cr" title=""><?= $this->Number->format($this->Html->totalFunds()) ?></span></dd>
				</dl>
				<dl class="amount-list">
					<dt>Successful Busks</dt>
						<dd class="round-3"><span class="c" title="eight"><?= $this->Number->format($this->Html->totalPaid()) ?></span></dd>
				</dl>
                <dl class="amount-list">
					<dt>Total Views</dt>
						<dd class="round-3"><span class="c top-space js-tooltip" title="<?php echo 'Today  : '. $day.' '.'Last Week : ' . $week.' Last Month : ' . $month.' Last Year : ' . $year; ?>" data-placement="top"><?= $all; ?></span></dd>
                        <?php //echo $this->Html->link($this->Number->format($this->Html->totalViewCounts()), array('controller'=> 'view_states', 'action' => 'index')); ?>
				</dl>
                <dl class="amount-list">
					<dt>Online Users</dt>
						<!-- <dd class="round-3"><span class="c" title="<?php echo $this->Number->format($this->Html->userCounts()); ?>"><?php echo $this->Number->format($this->Html->userCounts()); ?></span></dd> -->
                        <dd class="round-3"><span class="c" title="<?= $online ?>"><?= $online ?></span></dd>
				</dl>
			</div>
