...
<div class="nav-collapse">
  ...
  ?>
	...
	<li <?php echo $class;?>>
	<?php echo $this->Html->link(__l('Learn'),'/how-it-works',array('title'=>'Learn more'));?>
	</li>
	<li>
	...
	<li>
	<?php echo $this->Html->link('' . __l('Montage') . '</span>', array('controller' => 'montages', 'action' => 'index', 'admin' => false), array('title' => __l('Montage'),'class' => 'clearfix dc', 'escape' => false));?>
	</li>
	<li>
	<?php echo $this->Html->link('' . __l('Blog') . '</span>', array('controller' => 'blog', 'action' => 'index', 'admin' => false), array('title' => __l('Blog'),'class' => 'clearfix dc', 'escape' => false));?>
	</li>
	</ul>
	...
	<ul class="unstyled span hide rightMenu" id="js-before-login-head-menu">
		...
		<li class="span top-space">
		  <?php echo $this->Html->link(__l('Register'), array('controller' => 'users', 'action' => 'register', 'manual', 'admin' => false), array('class' => 'greenc textb', 'title' => __l('Register')));?>
		</li>
		<li class="span top-space">
  ...
  <div class="span dropdown tab-float">
	...
	<li><?php echo $this->Html->link(__l('Browse All'), array('controller' => 'pledge', 'action' => 'browse', 'admin'=>false), array('title' => __l('Browse All')));?></li>
	<li><?php echo $this->Html->link(__l('Cities'), array('controller' => 'cities', 'action' => 'index', 'admin' => false), array('title' => __l('Cities')));?></li>
	<li><?php echo $this->Html->link(__l('Category'), array('controller' => 'pledge_project_categories', 'action' => 'listall', 'admin' => false), array('title' => __l('Category')));?></li>
	<li><?php echo $this->Html->link(__l('Montage'), array('controller' => 'montages', 'action' => 'index', 'admin' => false), array('title' => __l('Montage')));?></li>
	</ul>
  </div>
  <div class="btn-group span hor-space dropdown tab-float">
	<?php
