...
<div class="bot-mspace clearfix pledge-block bot-space show-inline" itemtype="http://schema.org/Product" itemscope>
   <div class="home-round-block js-home-hover clearfix no-mar">
		<div class="span dc clearfix pledge"><?php echo $this->Html->link(__l('Browse'), array('controller' => 'projects', 'action' => 'discover', 'project_type'=>'pledge' , 'admin' => false), array('class'=>'btn btn-module span ver-smspace js-tooltip','title' => __l('Browse')));?><span class="space textb span no-mar text-14"><?php echo __l('OR'); ?></span><?php echo $this->Html->link(sprintf(__l('Start %s'), Configure::read('project.alt_name_for_project_singular_caps')), array('controller' => 'projects', 'action' => 'add', 'project_type'=>'pledge', 'admin' => false), array('title' => sprintf(__l('Start %s'), Configure::read('project.alt_name_for_project_singular_caps')),'class' => 'btn btn-module span ver-smspace js-tooltip', 'escape' => false));?>
	  </div>
	</div>
</div>
</div>
...
<?php 
		$i=1;
		//echo '<pre>'; print_r($how); exit;
		foreach($how as $hows) {
			
 ?>			
	<div class="block">
		<div class="row pr">
				<h5 class="grey-bg-head dc pa">Step-<?php echo $i;?></h5>
					<div class="lighter-green-bg">
						<div class="span23 pull-left sep-right">
							<h5 class="text-18 space"><?php echo $hows['Staticpage']['title'];?></h5>
							<p class="space textb">
							<?php echo $hows['Staticpage']['body'];?>
							</p>
						</div>
						...
						echo $this->Html->showImage($hows['Attachment']['dir'], $hows['Attachment'], array('dimension' => 'big_thumb','alt' => 'Learn', 'width'=>'50' , 'height'=>'50')); ?>
						</div>
					</div>
		</div>
	</div>
