...
<div class="translations form space">
  ...
  <?php echo $this->Form->create('Translation', array('action' => 'manage', 'class' => 'form-horizontal')); ?>
    <fieldset>
      ...
      ?>
      <div class="clearfix"><?php echo $this->Form->submit(__l('Submit'), array('name' => 'data[Translation][makeSubmit]')); ?></div>
      <?php
      ...
      <table class="table table-striped table-bordered table-condensed">
        ...
        ?>
        <tr>
          <td class="select"> <?php echo $this->Form->input('Translation.'.$translation['Translation']['id'].'.is_verified', array('checked' => ($translation['Translation']['is_verified'])?true:false, 'label' => false)); ?></td>
        ...
        ?>
        <tr>
          <td colspan="2"><div class="errorc space"><i class="icon-warning-sign errorc"></i> <?php echo sprintf(__l('No %s available'), __l('Translations'));?></div></td>
        </tr>
        <?php
          endif;
        ?>
