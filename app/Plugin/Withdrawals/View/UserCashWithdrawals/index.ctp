...
<div class="clearfix containter">
  <div class="clearfix"><h2 class="ver-space ver-mspace span no-mar"><?php echo __l('Withdraw Fund Request'); ?></h2>
  ...
  <div class="thumbnail main-section">
    <div class="userCashWithdrawals index js-response js-withdrawal_responses js-responses">
      <?php if(!empty($moneyTransferAccounts)) : ?>
        <div class="clearfix">
          <span class="pull-right bot-mspace">
            <?php
