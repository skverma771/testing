...
<div class="userCashWithdrawals index js-response space">
  ...
  <table class="table table-striped table-bordered table-condensed table-hover">
    <tr>
	  ...
	  <th class="dl"><?php echo __l('Money Transfer Accounts');?></th>
      <th class="dr"><div><?php echo $this->Paginator->sort('User.total_amount_withdrawn', __l('Paid Amount')).' ('.Configure::read('site.currency').')';?></div></th>
    </tr>
    <?php
      $i = 0;
