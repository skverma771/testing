...
<?php } ?>
<div class="blogs form js-ajax-form-blog-container">
  ...
  <?php endif; ?>
  <div>
    <?php echo $this->Form->create('Blog', array('class' => 'form-horizontal js-modal-form-blog-add {responsecontainer:"js-ajax-form-blog-container", refresh:"refresh" }')); ?>
      <?php if (!empty($this->request->params['admin'])): ?>
        <ul class="breadcrumb">
      ...
      <div class="form-actions no-bor <?php echo !empty($project['ProjectType']['slug']) ? $project['ProjectType']['slug'] : ''; ?>"><?php  echo $this->Form->submit(__l('Publish'), array('name' => 'data[Blog][publish]', 'class' => 'btn btn-module', 'div' => false)); ?> </div>
