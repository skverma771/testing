...
<ul class="unstyled row">
  ...
  ?>
  <li class="span dc pull-left no-mar">
  <?php
  ...
  ?>
  <li class="span thumbnail more dc pull-left "><?php echo $this->Html->link( $this->Html->cText('+' . $extra . ' ' . __l('More') . ' &#187;', false), array('controller' => 'projects', 'action' => 'view', $projectFollowers[0]['Project']['slug'], '#followers'), array('title' => __l('Show all Followers')));  ?></li>
  <?php
    }
