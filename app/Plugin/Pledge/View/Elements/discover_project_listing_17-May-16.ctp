	  ...
	  <div class="filter-menu">
		<h3 class="text-14 mtop-20 textb">Browse Projects</h3>
			<ul class="unstyled side-bar order-list no-mar">
				<li class="active"><a href="/projects/filter/recommended" title="Recommended">Recommended</a></li>
				<li><a href="#" title="Popular">Popular</a></li>
				<li><a href="#" title="Almost Funded">Almost Funded</a></li>
				<li><a href="#" title="Ending Soon">Ending Soon</a></li>
				<li><a href="#" title="Small Projects">Small Projects</a></li>
