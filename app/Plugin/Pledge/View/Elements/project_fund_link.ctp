...
<div class="clearfix bot-mspace dc">
<?php if(($this->Auth->user('id') != $project['Project']['user_id']) || Configure::read('Project.is_allow_owner_fund_own_project')):?>
  <a href="<?php echo Router::url(array('controller' => 'project_funds', 'action' => 'add', $project['Project']['id']), true); ?>" class="show-inline ver-mspace dc tip-btn-image js-tooltip" title="<?php echo Configure::read('project.alt_name_for_pledge_singular_caps'); ?>"> <?php echo Configure::read('project.alt_name_for_pledge_singular_caps'); ?></a>
<?php else : ?>
  <span class="disabled show-inline ver-mspace dc tip-btn-image js-tooltip" title="<?php echo sprintf(__l('Disabled. Reason: You can\'t %s your own %s.'), Configure::read('project.alt_name_for_pledge_singular_small'), Configure::read('project.alt_name_for_project_singular_small')); ?>"><?php echo Configure::read('project.alt_name_for_pledge_singular_caps');?></span>
<?php endif; ?>
</div>
<?php else :
  $status_response = Cms::dispatchEvent('View.Project.projectStatusValue', $this, array(
...
?>
<div class="clearfix bot-mspace dc">
  <span class="disabled show-inline ver-mspace dc tip-btn-image js-tooltip" title="<?php echo sprintf(__l('Disabled. Reason: %s.'),  $reason); ?>"><?php echo Configure::read('project.alt_name_for_pledge_singular_caps');?></span>
</div>
<?php endif;?>
<?php }?>