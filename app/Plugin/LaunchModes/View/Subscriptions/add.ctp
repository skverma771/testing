<?php if (Configure::read('site.launch_mode') == 'Private Beta') { ?>
  <?php if (!$success_msg): ?>
    ...
    <div class="submit btn-align span"><?php echo $this->Form->submit(__l('Request Invite')); ?></div>
...
<?php } else { ?>
  <?php if (!$success_msg): ?>
    <div class="clearfix">
      ...
      <div class="submit btn-align span"><?php echo $this->Form->submit(__l('Notify Me')); ?></div>
      <?php echo $this->Form->end(); ?>
    </div>
