<section>
	<div class="clearfix">
<h2 class="dc textn banner-bottom blue_text">
    <?php echo __l('The Global Tipping Portal for Street Performers'); ?>
  </h2>
		...
		<?php if ($home_videos):?>
			...
			<div class="row dc video-home-page-bg">
				...
				?>
					...
					<div class="navbar-right home-video mob-dr pa" style="cursor: pointer;"><?php echo $this->Html->image("close-button.png", array('style' => 'width:35px'));?></div>
					</div>
									...
									<div class="pr clearfix bor-grey">
											<div class="span12 no-mar wid-50">
												...
												if (!empty($home_videos[0]['HomeVideo']['video_url'])) {
                                                    echo $this->Embed->hotFixEmbed($home_videos[0]['HomeVideo']['video_url']);
											...
											<div class="span12 no-mar pull-right wid-50">
												<div class="right-content">
                                                    ...
                                                    <div class="video-title">
                                                        <h3 class="space dl whitec"><?php echo __l($home_videos[0]['HomeVideo']['title']); ?></h3>
                                                    </div>
                                                    ...
                                                    <div class="no-round"> 
                                                        <div class="clearfix space dl mob-dc">
                                                            ...
                                                            echo $this->Html->link('START YOUR CAMPAIGN', $url, array('title'=>__l('START YOUR CAMPAIGN'), 'class'=>'btn btn-large btn-primary js-no-pjax start-btn', 'escape' => false));?><?php echo $this->Html->link('Learn More About Buskerdues', '/how-it-works', array('title'=>__l('Learn More About Buskerdues'), 'class'=>'btn btn-large btn-primary js-no-pjax  learn-btn', 'escape' => false));?>	
                                                        </div>
                                                    </div>
                                                </div>
											</div>
