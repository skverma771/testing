						...
						<div class="space span24 videobgcolor">
									...
									<div class="pr">
											...
											<div class="no-round"> 
												  ...
												  <?php echo $this->Html->link('Download your free HOW to Guide now', array('controller'=> 'home_videos', 'action' => 'homepage_pdf_download', $home_videos[0]['HomeVideo']['id'], $home_videos[0]['HomeVideo']['attachment_id']), array('target' => '_blank', 'title'=>__l('Download PDF'), 'class'=>'btn btn-large btn-primary', 'escape' => false));?>		
												  </div>
											</div>
											</div>
									</div>
