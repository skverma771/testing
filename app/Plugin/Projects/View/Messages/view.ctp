      ...
      <div class="message-block-right">
        ...
        <?php
          if ($message['Message']['is_sender'] == 0) : ?>
            <p><span class="show-details-left"><?php echo __l('From').': ';  ?></span> <?php echo $message['OtherUser']['username']; ?> < <?php echo $message['OtherUser']['email']; ?> ></p>
          <?php
          else : ?>
            <p><span class="show-details-left"><?php echo __l('From').': ';  ?></span> <?php echo $message['User']['username']; ?> < <?php echo $message['User']['email']; ?> ></p>
          <?php
          endif; ?>
