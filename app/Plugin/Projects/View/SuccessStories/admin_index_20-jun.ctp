...
<div class="cities index js-response">
  <div class="row-fluid">
    ...
    <section class="space">
      ...
      <th class="dl"><div><?php echo $this->Paginator->sort('Project.name', __l('Project') , array('url'=>array('controller'=>'success_stories', 'action'=>'index')));?></div></th>
      <th class="dl"><div><?php echo $this->Paginator->sort('Project.collected_amount', __l('Collected Amount') , array('url'=>array('controller'=>'cities', 'action'=>'index')));?></div></th>
      <th class="dl"><div><?php echo $this->Paginator->sort('Project.collected_percentage', __l('Collected Percentage'));?></div></th>
      ...
      <th><div><?php echo $this->Paginator->sort('Video URL', __l('Video URL'));?></div></th>
