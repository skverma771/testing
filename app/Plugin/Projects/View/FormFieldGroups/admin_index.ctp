...
<div class="FormFieldGroups index js-response space">
  ...
  <ul class="nav nav-tabs">
    <li>
    <?php echo $this->Html->link('<i class="icon-th-list blackc"></i>'.__l('List'), array('controller' => 'project_types', 'action' => 'index'),array('class' => 'blackc', 'title' =>  __l('List'),'data-target'=>'#list_form', 'escape' => false));?>
    </li>
    ...
    <ol class="unstyled no-pad no-mar clearfix">
      ...
      <div class="js-sortable-group">
       ...
       <?php foreach($FormFieldGroups as $FormFieldGroup) {?>
        <div class="hide">
          ...
          <div class="row-fluid">
           <div class="span1 dropdown top-space dc pull-left">
            ...
            <h5 class="hor-space"><?php echo $FormFieldGroup['FormFieldGroup']['name'].' ';?></h5>
            </div>
        ...
        <?php else:?>
         <li>
        <div class="errorc space"><i class="icon-warning-sign errorc"></i> <?php echo sprintf(__l('No %s available'), __l('Form Field Groups'));?></div>
        </li>
     </ol>
<?php
endif;?>
