    ...
    <ol class="unstyled no-pad no-mar">
      ...
      <div class="js-sortable-group">
       ...
       <?php foreach($FormFieldSteps as $FormFieldStep) {?>
        <div class="hide">
          ...
          <div class="row-fluid">
           <div class="span1 dropdown top-space dc pull-left">
            ...
            <h5 class="hor-space"><?php echo $FormFieldStep['FormFieldStep']['name'].' ';?></h5>
            </div>
        ...
        <?php else:?>
         <li>
        <div class="errorc space"><i class="icon-warning-sign errorc"></i> <?php echo sprintf(__l('No %s available'), __l('Form Field Steps'));?></div>
        </li>
     </ol>
<?php
endif;?>
