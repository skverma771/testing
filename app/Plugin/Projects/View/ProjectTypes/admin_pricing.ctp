...
<div class="space">
  ...
  <li class="active"><a class="blackc" href="#pricing"><i class="icon-briefcase"></i><?php echo __l('Pricing');?></a></li>
  ...
  <div class="alert alert-info"><?php echo sprintf(__l('Manage listing fee and funding commision details for this %s type. You can override the details here and this will be final.'), Configure::read('project.alt_name_for_project_singular_small')); ?></div>
  <div id="pricing" class="ProjectType form space"> <?php echo $this->Form->create('ProjectType', array('class' => 'form-horizontal'));?>
  <div class="clearfix">
    <div class="pull-right"><?php echo $this->Html->link('<i class="icon-cogs"></i> '.__l('Global Settings'), array('controller' => 'settings', 'action' => 'edit', 18), array('class' => 'blackc', 'title' =>  __l('Global Settings'), 'escape' => false)); ?></div>
  </div>
  <fieldset>
  ...
  <div class="form-actions <?php echo  $projectType['ProjectType']['slug']; ?>"> <?php echo $this->Form->submit(__l('Update'), array('class' => 'btn btn-module'));?> </div>
