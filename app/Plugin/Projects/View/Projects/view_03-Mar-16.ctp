...
<div class="ver-space pr clearfix js-project-view" data-project-id="<?php echo $project['Project']['id']; ?>">
	...
	?>
	<section data-offset-top="10" data-spy="affix" class="panel-section project-affix row no-mar <?php echo $class; ?> affix-top js-affix-header hp-affix" itemtype="http://schema.org/Person" itemscope>
						...
						<div class="clearfix share-block">
							...
							<div class="row share">
								<ul class="unstyled span top-space">
									<li class="span"><?php echo $this->Html->link('<i class="icon-chevron-left"></i><i class="icon-chevron-right"></i>'.__l(' Embed'), '#embed_frame', array('data-toggle' => 'modal', 'data-target' => '#embed_frame', 'escape' => false, 'class' => 'js-no-pjax blackc', 'title' => __l('Embed Code')));?></li>
								</ul>
								...
								<div class="row  bot-mspace">
									<div class='span1 space'>
										<?php if(!empty($submissionField['SubmissionThumb']['mimetype']) && ($submissionField['SubmissionThumb']['mimetype'] == 'image/jpeg' || $submissionField['SubmissionThumb']['mimetype'] == 'image/png' || $submissionField['SubmissionThumb']['mimetype'] == 'image/jpg' || $submissionField['SubmissionThumb']['mimetype'] == 'image/gif')) {?>
											<?php echo $this->Html->showImage('SubmissionThumb', $submissionField['SubmissionThumb'], array('dimension' => 'micro_thumb', 'alt' => sprintf(__l('[Image: %s]'), $this->Html->cText($project['Project']['name'], false)), 'escape' => false));?>
