...
<div class="space projects js-responses <?php echo $form_class;?>">
	...
	<div>
		<?php
			echo $this->Form->create('Project', array('url' => array('controller' => 'projects', 'action'=> 'add', 'project_type' => $project_type_slug), 'class' => 'form-horizontal js-project-form edit-form clearfix','enctype' => 'multipart/form-data'));
