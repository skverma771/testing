...
?>
  <h5 class="bot-mspace bot-space"><?php echo $heading; ?></h5>
<?php
  }
  $hide_box_cls = false;
...
<?php if (!empty($this->request->params['named']['city']) || !empty($this->request->params['named']['category'])  || isset($this->request->params['named']['q'])):
 ?>
<?php if(!$ajax_view){ ?>
      <div class="page-header"><h2><?php echo $this->html->cText($heading);?></h2></div>
<?php } ?>
<?php endif; ?>
<?php if ((!empty($this->request->params['named']['view']) && $this->request->params['named']['view'] == 'discover') || !empty($this->request->params['named']['filter'])): ?>
    <div>
	<?php if(!empty($this->request->params['named']['limit']) && $this->request->params['named']['limit']==4): ?>
...
<?php
if (!empty($projects)): ?>
<ol class="<?php echo $ideaClass; ?> thumbnails row <?php echo (!empty($this->request->params['named']['is_idea'])) ? 'idea-list' : '' ;?>">
<?php
  $isEquityEnabled = 0;
          ...
          <section class="thumbnail">
			...
			?>
              <div class="list-content pr">
                <h5 class="top-mspace bot-space htruncate home-list-title">
				...
				<?php if(isPluginEnabled('ProjectFollowers')) { ?>
						<?php if(isPluginEnabled('HighPerformance') && (Configure::read('HtmlCache.is_htmlcache_enabled') || Configure::read('cloudflare.is_cloudflare_enabled'))) {
							...
							<div class='alpf-<?php echo $project['Project']['id'];?> hide'>
									  <?php echo $this->Html->link("<i class='icon-ok'></i> ". __l('Following'), array('controller' => 'project_followers', 'action' => 'delete', $projectfollower_id),array('class' => "show btn span4 ver-mspace dc js-tooltip  js-unfollow",'escape' => false,'data-addtitle'=>"Following", 'data-addlabel'=>"Following", 'data-loadinglabel'=>"Loading...", 'data-deletetitle'=>"Follow", 'data-deletelabel'=>"Follow", 'data-addclass'=>"btn", 'data-removeclass'=>"btn", 'title'=>__l('Unfollow'))); ?>
							</div>
							<div class='alpuf-<?php echo $project['Project']['id'];?> hide'>
										<?php echo $this->Html->link(__l('Follow'), array('controller' => 'project_followers', 'action' => 'add', $project['Project']['id']),array('class' => "show btn span4 ver-mspace dc js-tooltip js-ajax-statchange js-no-pjax",'data-toggle'=>"dropdown", 'data-addtitle'=>"Follow", 'data-addlabel'=>"Follow", 'data-loadinglabel' => "Loading...",  'data-deletetitle' => "Unfollow",  'data-deletelabel' => "Unfollow", 'data-addclass' => "btn", 'data-removeclass' => "btn", 'title'=>__l('Follow')));  ?>
							</div>
							<div class='blpuf-<?php echo $project['Project']['id'];?> hide'>
										 <?php echo $this->Html->link(__l('Follow'), array('controller' => 'users', 'action' => 'login', '?' => 'f=project/' . $project['Project']['slug'], 'admin' => false),array('class' => "show btn span4 ver-mspace dc js-tooltip js-ajax-statchange js-no-pjax",'data-toggle'=>"dropdown", 'data-addtitle'=>"Follow", 'data-addlabel'=>"Follow", 'data-loadinglabel' => "Loading...",  'data-deletetitle' => "Unfollow",  'data-deletelabel' => "Unfollow", 'data-addclass' => "btn", 'data-removeclass' => "btn", 'title'=>__l('Follow'))); ?>
							</div>
						<?php } else {?>
							<?php if (!empty($project['ProjectFollower'])): ?>
							  <?php echo $this->Html->link("<i class='icon-ok'></i> ". __l('Following'), array('controller' => 'project_followers', 'action' => 'delete', $project['ProjectFollower'][0]['id']),array('class' => "show btn span4 ver-mspace dc js-tooltip  js-unfollow",'escape' => false,'data-addtitle'=>"Following", 'data-addlabel'=>"Following", 'data-loadinglabel'=>"Loading...", 'data-deletetitle'=>"Follow", 'data-deletelabel'=>"Follow", 'data-addclass'=>"btn", 'data-removeclass'=>"btn", 'title'=>__l('Unfollow'))); ?>
							<?php else: ?>
							<?php
                    ...
                    <div class="row over-details top-space">
                      <div class="space mspace span5">
                        ...
                        <?php if (isPluginEnabled('ProjectFollowers')) {
							...
							<div class='alpuf-<?php echo $project['Project']['id'];?> hide'>
										<?php echo $this->Html->link(__l('Follow'), array('controller' => 'project_followers', 'action' => 'add', $project['Project']['id']),array('class' => 'show btn span4 ver-mspace dc js-tooltip', 'title'=>__l('Follow')));  ?>
							</div>
							<div class='blpuf-<?php echo $project['Project']['id'];?> hide'>
										 <?php echo $this->Html->link(__l('Follow'), array('controller' => 'users', 'action' => 'login', '?' => 'f=project/' . $project['Project']['slug'], 'admin' => false),array('class' => 'show btn span4 ver-mspace dc js-tooltip', 'title'=>__l('Follow'))); ?>
							</div>
						<?php } else {?>
                            ...
                            <?php else: ?>
							  ...
							  <?php
							  if ($this->Auth->sessionValid()) {
                              	echo $this->Html->link(__l('Follow'), array('controller' => 'project_followers', 'action' => 'add', $project['Project']['id']),array('class' => 'show btn span4 ver-mspace dc js-tooltip', 'title'=>__l('Follow')));
								} else {
								echo $this->Html->link(__l('Follow'), array('controller' => 'users', 'action' => 'login', '?' => 'f=project/' . $project['Project']['slug'], 'admin' => false),array('class' => 'show btn span4 ver-mspace dc js-tooltip', 'title'=>__l('Follow')));
								}
								?>
                            <?php endif; ?>
