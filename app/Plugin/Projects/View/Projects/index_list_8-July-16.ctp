					...
					<section class="project-bg">
						...
						<div class="list-content">   
							...
							<p class="htruncate dl">             
									...
									<span class="flags flag-in"></span><?php echo $this->Html->link($this->Html->cText($project['Project']['address']), array('controller' => 'projects', 'action' => 'index', 'city' => $project['City']['slug']), array('escape' => false, 'title' => $this->Html->cText($project['Project']['address'], false)));?>
									</span>
							</p>
...
<div class="clearfix dc pledge ver-mspace space">
	<p class="btn btn-module ver-mspace" title="Tip more projects"> 
<?php echo $this->Html->link(__l('Tip more projects'), array('controller' => 'pledge', 'action' => 'browse'),array('class' => 'blackc'));?>
	</p>
</div>
