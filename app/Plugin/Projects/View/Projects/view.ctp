<style>
    #project-details .clearfix .video-container .overlay-text {
        position: absolute;
        font-size: 24px;
        z-index: 99;
        color: #fff;
			...
			<article class="span15 panel-container">
				<div class="tab-pane fade in active" id="project-details" style="display: block;">
					<section class="clearfix">
							<?php if (!empty($project['Project']['video_url_2'])): ?>
							<div class="clearfix">
								<div class="ver-space" >
								<?php
                                    echo $this->Embed->hotFixEmbed($project['Project']['video_url_2'], 'My Story');
								?>	
								</div>	
							</div>
							<?php endif; ?>
                            ...
                            <div class="clearfix">
                                <div class="ver-space" >
                                <?php
                                    echo $this->Embed->hotFixEmbed($project['Project']['video_embed_url'], 'My Busk');
                                ?>
                                </div>	
                            </div>
                            <?php endif; ?>
							...
							<div class="row share">
								<ul class="unstyled span top-space">
									...
									<li class="span share-icon">
										<div class="addthis_toolbox addthis_default_style"> <a class="addthis_button_compact" href="https://www.addthis.com/bookmark.php?v=250&amp;username=xa-4be1665734d1eaab"><?php echo __l('Share'); ?></a>
											<script type="text/javascript" src="https://s7.addthis.com/js/250/addthis_widget.js#username=xa-4be1665734d1eaab"></script>
										</div>
									</li>
									<li class="span twit">
                        <script src="https://platform.twitter.com/widgets.js" type="text/javascript"></script>
                        <a href="https://twitter.com/share?url=<?php echo $project_url; ?>&amp;text=<?php echo $this->Html->cText($project['Project']['name'], false);?>&amp;lang=en&amp;via=<?php echo Configure::read('site.name'); ?>&amp;count=none" class="twitter-share-button" target="_blank"><?php echo __l('Tweet!');?></a></li>
