...
<div class="ver-space pr clearfix js-project-view" data-project-id="<?php echo $project['Project']['id']; ?>">
	...
	<section data-offset-top="10" class="panel-section project-affix row no-mar <?php echo $class; ?> affix-top" itemtype="http://schema.org/Person" itemscope>
		...
		<div class="clearfix">
            <h6 style="font-size:10px;"><a href = "https://chart.googleapis.com/chart?cht=qr&chl=<?php echo Router::url('/', true).'project/'.$project['Project']['slug']; ?>&chs=120x120&chld=L|0" download title="Download QR Code"/>Download (120 x 120)</a></h6>
          </div>
          <div class="clearfix">
              <h6 style="font-size:10px;"><a href = "https://chart.googleapis.com/chart?cht=qr&chl=<?php echo Router::url('/', true).'project/'.$project['Project']['slug']; ?>&chs=250x250&chld=L|0" download title="Download QR Code"/>Download (250 x 250)</a></h6>
          </div>
          <div class="clearfix">
              <h6 style="font-size:10px;"><a href = "https://chart.googleapis.com/chart?cht=qr&chl=<?php echo Router::url('/', true).'project/'.$project['Project']['slug']; ?>&chs=400x400&chld=L|0" download title="Download QR Code"/>Download (400 x 400)</a></h6>
          </div>
		</div>
	</div>
