                ...
                <section class="trans-bg list-details pr dc">
                  <div class="row over-details top-space">
                    <div class="space mspace span5">
                      <div class="clearfix top-mspace mleft-minus dropdown">
                    ...
                    <div class="row over-details top-space">
                      <div class="space mspace span5">
                        ...
                        <?php if (isPluginEnabled('ProjectFollowers')) {
							...
							<div class='alpuf-<?php echo $project['Project']['id'];?> hide'>
										<?php echo $this->Html->link(__l('Follow'), array('controller' => 'project_followers', 'action' => 'add', $project['Project']['id']),array('class' => 'show btn span4 ver-mspace dc btn-primary js-tooltip', 'title'=>__l('Follow')));  ?>
							</div>
							<div class='blpuf-<?php echo $project['Project']['id'];?> hide'>
										 <?php echo $this->Html->link(__l('Follow'), array('controller' => 'users', 'action' => 'login', '?' => 'f=project/' . $project['Project']['slug'], 'admin' => false),array('class' => 'show btn span4 ver-mspace dc btn-primary js-tooltip', 'title'=>__l('Follow'))); ?>
							</div>
						<?php } else {?>
                            ...
                            <?php else: ?>
							  ...
							  <?php
							  if ($this->Auth->sessionValid()) {
                              	echo $this->Html->link(__l('Follow'), array('controller' => 'project_followers', 'action' => 'add', $project['Project']['id']),array('class' => 'show btn span4 ver-mspace dc btn-primary js-tooltip', 'title'=>__l('Follow')));
								} else {
								echo $this->Html->link(__l('Follow'), array('controller' => 'users', 'action' => 'login', '?' => 'f=project/' . $project['Project']['slug'], 'admin' => false),array('class' => 'show btn span4 ver-mspace dc btn-primary js-tooltip', 'title'=>__l('Follow')));
								}
								?>
                            <?php endif; ?>
