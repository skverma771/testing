...
?>
  <li>
    <p class="errorc space"><i class="icon-warning-sign errorc"></i> <?php echo sprintf(__l('No %s available'), __l('User Add Wallet Amounts'));?></p>
  </li>
<?php
endif;
?>
