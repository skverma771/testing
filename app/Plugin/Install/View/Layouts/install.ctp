...
<head>
  ...
  <title><?php echo $title_for_layout; ?> - <?php echo __l('Crowdfunding'); ?></title>
  ...
  <div class="container_24">
    <div class="header">
      <div class="h-left">
        <div class="h-right">
          <div class="h-center">
            <h1 class="grid_left"><a href="#" title="Crowdfunding">Crowdfunding</a></h1>
    ...
    <div class="main clearfix">
      <div class="side-content grid_7">
        ...
        <ol class="list round-4 grid_6">
          ...
          <li class="round-4<?php if ($this->request->params['action'] == 'configuration') { ?> active<?php } ?>">6. Crowdfunding Configuration</li>
    ...
    <div class="footer">
      <div class="footer-inner clearfix">
        <p>&copy;<?php echo date('Y'); ?> <a title="crowdfunding" href="http://crowdfunding.dev.agriya.com/">Crowdfunding</a>. All rights reserved.</p>
        <p class="powered clearfix"><span><a class="powered" target="_blank" title="Powered by Crowdfunding" href="http://crowdfunding.dev.agriya.com/">Powered by Crowdfunding</a>,</span>
