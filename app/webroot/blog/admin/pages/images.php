...
<div class="card">
 	...
 	<a class="btn btn-default pull-right" href="index.php?page=edit&id=<?php echo $id;?>" style="margin-top:12px;margin-right:12px;"><i class="ti-angle-left"></i> <?php echo $this->texts["go_back"];?></a>
	<div class="clearfix"></div>

	<div class="header">
		<h4 class="title"><?php  echo $this->texts["modify_images"];?></h4>
		<br/>
		<i><?php  echo $this->texts["drag_images_order"];?></i>
	</div>
	...
	<div class="container" id="main_content">
			...
			if(isset($_REQUEST["current"])&&isset($_REQUEST["new"]))
			{
				...
				)
				{
					...
					$xml->listing[$id]->images=trim($current_images,",");
			...
			if(isset($_POST["proceed_save"]))
			{
				...
				$xml->asXML($this->data_file); 
				$current_images=trim($str_images_list,",");
			}	
			...
			<div class="row">
				<div class="col-md-8">
					...
					<input type="hidden" name="id" value="<?php echo $id;?>"/>
						...
						<h4 class="title"><?php echo $this->texts["upload_more_images"];?></h4>
						<hr/>
