...
;(function($, win, doc) {
	...
	$.anythingSlider = function(el, options) {
		...
		base.init = function(){
			...
			base.$startStop = $('<a class="start-stop"></a>');
		...
		base.buildNavigation = function() {
			if (o.buildNavigation && (base.pages > 1)) {
				...
				base.$items.filter(':not(.cloned)').each(function(j){
					...
					a = '<a class="panel' + i + ( base.navTextVisible ? '"' : ' ' + o.tooltipClass + '" title="@"' ) + '><span>@</span></a>';
				...
				if (!!o.navigationSize && o.navigationSize < base.pages) {
					if (!base.$controls.find('.anythingNavWindow').length){
						base.$nav
							.before('<ul><li class="prev"><a><span>' + o.backText + '</span></a></li></ul>')
							.after('<ul><li class="next"><a><span>' + o.forwardText + '</span></a></li></ul>')
		...
		base.buildNextBackButtons = function() {
			base.$forward = $('<span class="arrow forward"><a><span>' + o.forwardText + '</span></a></span>');
			base.$back = $('<span class="arrow back"><a><span>' + o.backText + '</span></a></span>');
