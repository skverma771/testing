 ...
 * ShippingAddressInfo. 
 */
if (!class_exists('ShippingAddressInfo')) {
 ...
 * 
 */
if (!class_exists('WarningDataList')) {
 ...
 */
if (!class_exists('StateRegulatoryAgencyInfo')) {
 ...
 */
if (!class_exists('PostPaymentDisclosure')) {
 ...
 * 
 */
if (!class_exists('PostPaymentDisclosureList')) {
...
class PayRequest  
  extends PPMessage   {
	 ...
	 * Constructor with arguments
	 */
	public function __construct($requestEnvelope = NULL, $actionType = NULL, $cancelUrl = NULL, $currencyCode = NULL, $receiverList = NULL, $ipnNotificationUrl = NULL, $returnUrl = NULL) {
		$this->requestEnvelope = $requestEnvelope;
 ...
 */
if (!class_exists('GetUserLimitsRequest')) {
 ...
 */
if (!class_exists('GetUserLimitsResponse')) {
 ...
 */
if (!class_exists('SenderDisclosure')) {
 ...
 */
if (!class_exists('ConversionRate')) {
 ...
 * Receiver/Receivers. 
 */
if (!class_exists('ReceiverDisclosure')) {
 ...
 * 
 */
if (!class_exists('ReceiverDisclosureList')) {
 ...
 * 
 */
if (!class_exists('ReceiverInfoList')) {
 ...
 */
if (!class_exists('GetPrePaymentDisclosureRequest')) {
 ...
 */
if (!class_exists('GetPrePaymentDisclosureResponse')) {
