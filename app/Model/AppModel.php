    ...
    function getGatewayTypes($field = null)
    {
        ...
        foreach($paymentGateways as $paymentGateway) {
            if (!empty($paymentGateway['PaymentGatewaySetting'])) {
                if (($paymentGateway['PaymentGateway']['id'] == ConstPaymentGateways::SudoPay && isPluginEnabled('Sudopay')) ||($paymentGateway['PaymentGateway']['id'] == ConstPaymentGateways::Paypal) || ($paymentGateway['PaymentGateway']['id'] == ConstPaymentGateways::Wallet && isPluginEnabled('Wallet'))) {
